...
import '../../features/about/application/about_cubit.dart' as _i130;
...
import '../../features/auth/data/repositories/auth_repository_impl.dart'
    as _i137;
import '../../features/auth/domain/auth_service.dart' as _i138;
import '../../features/auth/domain/repositories/auth_repository.dart' as _i136;
...
import '../../features/email-citas/application/bloc/email_citas_bloc.dart'
    as _i154;
import '../../features/email-citas/application/email_citas_cubit.dart' as _i155;
...
import '../../features/home/domain/repositories/home_repository.dart' as _i173;
...
import '../../features/medications/infrastructure/repositories/isar_medication_repository.dart'
    as _i77;
import '../../features/meditation/application/meditation_cubit.dart' as _i184;
...
import '../../features/reports/infrastructure/services/mock_report_generation_service.dart'
    as _i82;
import '../../features/settings/application/llm_settings_cubit.dart' as _i181;
...
import '../../features/settings/infrastructure/repositories/settings_repository_impl.dart'
    as _i109;
import '../../features/sync/application/sync_cubit.dart' as _i214;
...
import '../../features/sync/domain/services/node_discovery_service.dart'
    as _i90;
import '../../features/sync/domain/services/sync_service.dart' as _i197;
...
import '../../features/sync/infrastructure/services/ipfs_service.dart' as _i150;
...
import '../../features/vitals/application/vitals_cubit.dart' as _i124;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i116.UserProfileLocalDataSource>(
        () => _i116.UserProfileLocalDataSource(gh<_i58.Isar>()));
    gh.lazySingleton<_i117.UserProfileRepository>(
        () => _i118.UserProfileRepositoryImpl(gh<_i58.Isar>()));
    gh.lazySingleton<_i119.UserProfileService>(
        () => _i119.UserProfileService(gh<_i117.UserProfileRepository>()));
    gh.lazySingleton<_i120.VectorStoreService>(
        () => _i121.IsarVectorStoreService(
              gh<_i32.MemoryGraph>(),
              gh<_i67.MedicalKnowledgeRepository>(),
            ));
    gh.lazySingleton<_i122.VitalSignRepository>(
        () => _i123.VitalSignRepositoryImpl(gh<_i58.Isar>()));
    gh.factory<_i124.VitalsCubit>(
        () => _i124.VitalsCubit(gh<_i122.VitalSignRepository>()));
    gh.lazySingleton<_i125.VoiceChatRepository>(
    ...
    gh.factory<_i130.AboutCubit>(
        () => _i130.AboutCubit(gh<_i51.IAboutRepository>()));
    gh.lazySingleton<_i131.AboutRemoteDataSource>(
        () => _i131.AboutRemoteDataSource(gh<_i29.Dio>()));
    gh.lazySingleton<_i132.AllergyLocalDataSource>(
        () => _i132.AllergyLocalDataSource(gh<_i58.Isar>()));
    gh.lazySingleton<_i133.AllergyRepository>(
        () => _i134.AllergyRepositoryImpl(gh<_i132.AllergyLocalDataSource>()));
    gh.lazySingleton<_i135.AuthLocalDataSource>(
        () => _i135.AuthLocalDataSource(gh<_i58.Isar>()));
    ...
    gh.lazySingleton<_i140.CancelSharingUseCase>(
        () => _i140.CancelSharingUseCase(
              gh<_i139.BleSharingService>(),
              gh<_i89.NfcSharingService>(),
              gh<_i129.WifiDirectService>(),
            ));
    gh.lazySingleton<_i141.ChatMessageLocalDataSource>(
        () => _i141.ChatMessageLocalDataSource(gh<_i58.Isar>()));
    gh.lazySingleton<_i142.CompleteSessionUseCase>(
        () => _i142.CompleteSessionUseCase(gh<_i80.MeditationRepository>()));
    gh.factory<_i113.ConnectEmailProviderUseCase>(
        () => _i113.ConnectEmailProviderUseCase(gh<_i30.EmailRepository>()));
    gh.lazySingleton<_i143.ConnectNode>(
        () => _i143.ConnectNode(gh<_i85.NetworkRepository>()));
    gh.factory<_i144.ConnectProviderUseCase>(() => _i144.ConnectProviderUseCase(
          gh<_i93.OAuthRepository>(),
          gh<_i117.UserProfileRepository>(),
        ));
    gh.lazySingleton<_i145.DashboardLocalDataSource>(
        () => _i145.DashboardLocalDataSource(gh<_i58.Isar>()));
    gh.lazySingleton<_i146.DashboardRepository>(
        () => _i147.DashboardRepositoryImpl(
              gh<_i25.DashboardRemoteDataSource>(),
              gh<_i122.VitalSignRepository>(),
              gh<_i76.MedicationRepository>(),
              gh<_i100.ReportRepository>(),
            ));
    gh.factory<_i148.DisconnectProviderUseCase>(
        () => _i148.DisconnectProviderUseCase(
              gh<_i93.OAuthRepository>(),
              gh<_i117.UserProfileRepository>(),
            ));
    gh.lazySingleton<_i149.DistributedStorageService>(() => _i150.IpfsService(
          gh<_i57.IpfsDatasource>(),
          gh<_i37.FilecoinDatasource>(),
        ));
    gh.lazySingleton<_i151.DoctorProfileRepository>(
        () => _i152.IsarDoctorProfileRepository(gh<_i58.Isar>()));
    gh.factoryAsync<_i153.DoctorVerificationCubit>(
        () async => _i153.DoctorVerificationCubit(
              gh<_i151.DoctorProfileRepository>(),
              gh<_i97.RatingRepository>(),
              await getAsync<_i60.LicenseVerifier>(),
            ));
    gh.factory<_i154.EmailCitasBloc>(() => _i154.EmailCitasBloc(
    ...
    gh.factory<_i155.EmailCitasCubit>(() => _i155.EmailCitasCubit(
          gh<_i30.EmailRepository>(),
          gh<_i7.AppointmentRepository>(),
        ));
    ...
    gh.factory<_i156.GetChatHistoryUseCase>(
        () => _i156.GetChatHistoryUseCase(gh<_i125.VoiceChatRepository>()));
    gh.factory<_i157.GetConnectionsUseCase>(
        () => _i157.GetConnectionsUseCase(gh<_i93.OAuthRepository>()));
    gh.factory<_i158.GetDashboardStatsUseCase>(
        () => _i158.GetDashboardStatsUseCase(gh<_i146.DashboardRepository>()));
    gh.lazySingleton<_i159.GetNetworkHealth>(
        () => _i159.GetNetworkHealth(gh<_i85.NetworkRepository>()));
    gh.lazySingleton<_i160.GetNodeStats>(
        () => _i160.GetNodeStats(gh<_i85.NetworkRepository>()));
    gh.lazySingleton<_i161.GetProgressUseCase>(
        () => _i161.GetProgressUseCase(gh<_i80.MeditationRepository>()));
    gh.factory<_i162.GetRecentActivityUseCase>(
        () => _i162.GetRecentActivityUseCase(gh<_i146.DashboardRepository>()));
    gh.lazySingleton<_i163.GetScriptsUseCase>(
        () => _i163.GetScriptsUseCase(gh<_i80.MeditationRepository>()));
    gh.lazySingleton<_i164.GovernanceIpfsDatasource>(
        () => _i164.GovernanceIpfsDatasource(gh<_i57.IpfsDatasource>()));
    gh.lazySingleton<_i165.GovernanceRepository>(() =>
        _i166.GovernanceRepositoryImpl(gh<_i164.GovernanceIpfsDatasource>()));
    gh.lazySingleton<_i167.HealthDataImportRepository>(
        () => _i168.HealthDataImportRepositoryImpl(
              gh<_i106.SensorHealthDataSource>(),
              gh<_i106.FileHealthDataSource>(),
            ));
    gh.factory<_i169.HealthImportBloc>(() => _i169.HealthImportBloc(
          gh<_i102.GetAvailableSourcesUseCase>(),
          gh<_i102.RequestHealthAuthUseCase>(),
          gh<_i44.HealthDataImportService>(),
          gh<_i122.VitalSignRepository>(),
        ));
    gh.factory<_i170.HealthImportCubit>(() => _i170.HealthImportCubit(
          gh<_i44.HealthDataImportService>(),
          gh<_i122.VitalSignRepository>(),
        ));
    gh.lazySingleton<_i171.HealthRecordRepository>(
        () => _i172.HealthRecordRepositoryImpl(gh<_i58.Isar>()));
    gh.lazySingleton<_i173.HomeRepository>(() => _i174.HomeRepositoryImpl(
          gh<_i122.VitalSignRepository>(),
          gh<_i7.AppointmentRepository>(),
          gh<_i76.MedicationRepository>(),
    ...
    gh.factory<_i175.ImportCalendarUseCase>(() => _i175.ImportCalendarUseCase(
    ...
    gh.lazySingleton<_i179.LlmService>(() => _i180.GemmaLlmService(
          gh<_i120.VectorStoreService>(),
          gh<_i117.UserProfileRepository>(),
    ...
    gh.lazySingleton<_i182.MedicalResearchService>(
        () => _i182.MedicalResearchService(
              gh<_i74.MedicalWebSearchService>(),
              gh<_i70.MedicalScraperService>(),
            ));
    gh.factory<_i183.MedicationBloc>(
        () => _i183.MedicationBloc(gh<_i76.MedicationRepository>()));
    gh.factory<_i184.MeditationCubit>(() => _i184.MeditationCubit(
          gh<_i99.RecommendScriptUseCase>(),
          gh<_i112.StartSessionUseCase>(),
          gh<_i142.CompleteSessionUseCase>(),
          gh<_i161.GetProgressUseCase>(),
          gh<_i11.AudioService>(),
        ));
    gh.factory<_i185.NetworkHealthCubit>(() => _i185.NetworkHealthCubit(
          gh<_i159.GetNetworkHealth>(),
          gh<_i143.ConnectNode>(),
          gh<_i85.NetworkRepository>(),
        ));
    gh.lazySingleton<_i186.OnboardingRepository>(() =>
        _i187.OnboardingRepositoryImpl(gh<_i117.UserProfileRepository>()));
    gh.lazySingleton<_i188.PatientContextIndexer>(
      () => _i188.PatientContextIndexer(
        gh<_i58.Isar>(),
        gh<_i120.VectorStoreService>(),
        gh<_i171.HealthRecordRepository>(),
        gh<_i76.MedicationRepository>(),
        gh<_i133.AllergyRepository>(),
        gh<_i122.VitalSignRepository>(),
        gh<_i7.AppointmentRepository>(),
      ),
      dispose: (i) => i.dispose(),
    ...
    gh.factory<_i191.SecondOpinionCubit>(
        () => _i191.SecondOpinionCubit(gh<_i104.SecondOpinionRepository>()));
    gh.factory<_i192.SendMessageUseCase>(
        () => _i192.SendMessageUseCase(gh<_i125.VoiceChatRepository>()));
    gh.lazySingleton<_i193.SmartSearchUseCase>(
        () => _i193.SmartSearchUseCase(gh<_i120.VectorStoreService>()));
    ...
    gh.lazySingleton<_i197.SyncService>(() => _i198.SyncServiceImpl(
          gh<_i114.SyncRepository>(),
          gh<_i66.SyncService>(),
        ));
    gh.factory<_i199.UserProfileCubit>(
        () => _i199.UserProfileCubit(gh<_i117.UserProfileRepository>()));
    gh.factory<_i200.VitalSignBloc>(
        () => _i200.VitalSignBloc(gh<_i122.VitalSignRepository>()));
    gh.factory<_i201.VoiceChatCubit>(() => _i201.VoiceChatCubit(
          gh<_i192.SendMessageUseCase>(),
          gh<_i156.GetChatHistoryUseCase>(),
          gh<_i125.VoiceChatRepository>(),
          gh<_i11.AudioService>(),
        ));
    gh.factory<_i202.VouchCubit>(
        () => _i202.VouchCubit(gh<_i127.VouchRepository>()));
    gh.factory<_i203.AllergiesCubit>(
        () => _i203.AllergiesCubit(gh<_i133.AllergyRepository>()));
    gh.factory<_i204.AllergyBloc>(
        () => _i204.AllergyBloc(gh<_i133.AllergyRepository>()));
    ...
    gh.factory<_i209.CalendarImportCubit>(() => _i209.CalendarImportCubit(
          gh<_i19.CalendarImportRepository>(),
          gh<_i175.ImportCalendarUseCase>(),
        ));
    gh.factory<_i210.DashboardCubit>(() => _i210.DashboardCubit(
          gh<_i158.GetDashboardStatsUseCase>(),
          gh<_i162.GetRecentActivityUseCase>(),
        ));
    gh.lazySingleton<_i211.DistributedCacheUsecase>(() =>
        _i211.DistributedCacheUsecase(gh<_i149.DistributedStorageService>()));
    gh.factory<_i212.EpsConnectionBloc>(() => _i212.EpsConnectionBloc(
          gh<_i157.GetConnectionsUseCase>(),
          gh<_i144.ConnectProviderUseCase>(),
          gh<_i148.DisconnectProviderUseCase>(),
        ));
    ...
    gh.factory<_i214.FhirSyncCubit>(() => _i214.FhirSyncCubit(
          gh<_i197.SyncService>(),
          gh<_i90.NodeDiscoveryService>(),
        ));
    gh.factory<_i215.GetHealthSummaryUseCase>(
        () => _i215.GetHealthSummaryUseCase(gh<_i173.HomeRepository>()));
    ...
    gh.lazySingleton<_i179.LlmService>(
      () => _i218.RagLlmService(
        gh<_i120.VectorStoreService>(),
        gh<_i182.MedicalResearchService>(),
        gh<_i117.UserProfileRepository>(),
        gh<_i61.LlmAdapter>(instanceName: 'gemma'),
      ),
      instanceName: 'rag',
    ...
    gh.factory<_i222.OnboardingCubit>(
        () => _i222.OnboardingCubit(gh<_i186.OnboardingRepository>()));
    ...
    gh.factory<_i225.SharingCubit>(() => _i225.SharingCubit(
          bleService: gh<_i139.BleSharingService>(),
          nfcService: gh<_i89.NfcSharingService>(),
          wifiService: gh<_i129.WifiDirectService>(),
