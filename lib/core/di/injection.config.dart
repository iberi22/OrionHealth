...
import '../../features/about/infrastructure/repositories/about_repository_impl.dart'
    as _i54;
import '../../features/allergies/application/allergies_cubit.dart' as _i266;
import '../../features/allergies/application/bloc/allergy_bloc.dart' as _i267;
...
import '../../features/appointments/domain/usecases/save_appointment_usecase.dart'
    as _i109;
import '../../features/auth/application/auth_cubit.dart' as _i268;
...
import '../../features/clinical_assessments/infrastructure/repositories/assessment_repository_impl.dart'
    as _i188;
import '../../features/dashboard/application/dashboard_cubit.dart' as _i269;
...
import '../../features/health_record/infrastructure/services/ocr_service.dart'
    as _i99;
import '../../features/health_sharing/application/sharing_cubit.dart' as _i265;
...
import '../../features/health_sharing/infrastructure/wifi_direct_service.dart'
    as _i139;
import '../../features/home/application/home_cubit.dart' as _i273;
import '../../features/home/domain/repositories/home_repository.dart' as _i254;
...
import '../../features/network/network_health/infrastructure/repositories/network_repository_impl.dart'
    as _i90;
import '../../features/onboarding/application/onboarding_cubit.dart' as _i260;
...
import '../../features/onboarding/infrastructure/repositories/onboarding_repository_impl.dart'
    as _i206;
import '../../features/reports/application/bloc/report_bloc.dart' as _i262;
...
import '../../features/settings/infrastructure/repositories/settings_repository_impl.dart'
    as _i119;
import '../../features/sync/application/sync_cubit.dart' as _i244;
...
import '../../features/sync/domain/services/node_discovery_service.dart'
    as _i94;
import '../../features/sync/domain/services/sync_service.dart' as _i221;
...
import 'database_module.dart' as _i279;
import 'fhir_module.dart' as _i280;
import 'memory_module.dart' as _i278;
import 'network_module.dart' as _i277;
import 'service_module.dart' as _i276;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i143.AssessmentLocalDataSource>(
        () => _i143.AssessmentLocalDataSource(gh<_i60.Isar>()));
    ...
    gh.lazySingleton<_i149.ChatMessageLocalDataSource>(
        () => _i149.ChatMessageLocalDataSource(gh<_i60.Isar>()));
    ...
    gh.lazySingleton<_i163.EncryptionService>(
        () => _i163.EncryptionService(gh<_i113.SecureStorageService>()));
    ...
    gh.factory<_i165.GetAboutInfoUseCase>(
        () => _i165.GetAboutInfoUseCase(gh<_i53.IAboutRepository>()));
    ...
    gh.factory<_i167.GetAllVitalSignsUseCase>(
        () => _i167.GetAllVitalSignsUseCase(gh<_i132.VitalSignRepository>()));
    ...
    gh.factory<_i169.GetChatHistoryUseCase>(
        () => _i169.GetChatHistoryUseCase(gh<_i130.VectorStoreService>()));
    ...
    gh.factory<_i178.GetUserProfileUseCase>(
        () => _i178.GetUserProfileUseCase(gh<_i127.UserProfileRepository>()));
    ...
    gh.lazySingleton<_i182.HealthConnectDataSource>(
        () => _i182.HealthConnectDataSourceImpl(gh<_i49.HealthWrapper>()));
    ...
    gh.lazySingleton<_i185.HealthRecordRepository>(
        () => _i186.HealthRecordRepositoryImpl(gh<_i60.Isar>()));
    gh.lazySingleton<_i187.IAssessmentRepository>(
        () => _i188.AssessmentRepositoryImpl(gh<_i60.Isar>()));
    ...
    gh.factory<_i197.LogoutUseCase>(
        () => _i197.LogoutUseCase(gh<_i145.AuthRepository>()));
    ...
    gh.lazySingleton<_i205.OnboardingRepository>(() =>
        _i206.OnboardingRepositoryImpl(gh<_i127.UserProfileRepository>()));
    ...
    gh.factory<_i209.SaveCredentialsUseCase>(
        () => _i209.SaveCredentialsUseCase(gh<_i145.AuthRepository>()));
    ...
    gh.factory<_i211.SaveRecordUseCase>(
        () => _i211.SaveRecordUseCase(gh<_i185.HealthRecordRepository>()));
    gh.factory<_i212.SaveUserProfileUseCase>(
        () => _i212.SaveUserProfileUseCase(gh<_i127.UserProfileRepository>()));
    gh.factory<_i213.SaveVitalSignsUseCase>(
        () => _i213.SaveVitalSignsUseCase(gh<_i132.VitalSignRepository>()));
    ...
    gh.factory<_i215.SendMessageUseCase>(
        () => _i215.SendMessageUseCase(gh<_i135.VoiceChatRepository>()));
    gh.factory<_i216.SetPinUseCase>(() => _i216.SetPinUseCase(
          gh<_i145.AuthRepository>(),
          gh<_i163.EncryptionService>(),
        ));
    gh.lazySingleton<_i217.SmartSearchUseCase>(
        () => _i217.SmartSearchUseCase(gh<_i130.VectorStoreService>()));
    ...
    gh.lazySingleton<_i221.SyncService>(() => _i222.SyncServiceImpl(
          gh<_i124.SyncRepository>(),
          gh<_i68.SyncService>(),
        ));
    gh.factory<_i223.UserProfileCubit>(
        () => _i223.UserProfileCubit(gh<_i127.UserProfileRepository>()));
    gh.factory<_i224.ValidateSessionUseCase>(
        () => _i224.ValidateSessionUseCase(gh<_i145.AuthRepository>()));
    gh.factory<_i225.VitalSignBloc>(
        () => _i225.VitalSignBloc(gh<_i132.VitalSignRepository>()));
    ...
    gh.factory<_i227.VouchCubit>(
        () => _i227.VouchCubit(gh<_i137.VouchRepository>()));
    ...
    gh.lazySingleton<_i231.AuthService>(
        () => _i231.AuthServiceImpl(gh<_i163.EncryptionService>()));
    ...
    gh.factory<_i235.ClinicalAssessmentsCubit>(() =>
        _i235.ClinicalAssessmentsCubit(gh<_i187.IAssessmentRepository>()));
    gh.factory<_i236.CompleteOnboardingUseCase>(() =>
        _i236.CompleteOnboardingUseCase(gh<_i205.OnboardingRepository>()));
    ...
    gh.lazySingleton<_i241.DistributedCacheUsecase>(() =>
        _i241.DistributedCacheUsecase(gh<_i156.DistributedStorageService>()));
    ...
    gh.factory<_i244.FhirSyncCubit>(() => _i244.FhirSyncCubit(
          gh<_i221.SyncService>(),
          gh<_i94.NodeDiscoveryService>(),
        ));
    gh.factory<_i245.GetAllMedicationsUseCase>(
        () => _i245.GetAllMedicationsUseCase(gh<_i199.MedicationRepository>()));
    gh.factory<_i246.GetAllRecordsUseCase>(
        () => _i246.GetAllRecordsUseCase(gh<_i185.HealthRecordRepository>()));
    gh.factory<_i247.GetAllergiesUseCase>(
        () => _i247.GetAllergiesUseCase(gh<_i228.AllergyRepository>()));
    gh.factory<_i248.GetDashboardStatsUseCase>(
        () => _i248.GetDashboardStatsUseCase(gh<_i237.DashboardRepository>()));
    gh.factory<_i249.GetOnboardingProfileUseCase>(() =>
        _i249.GetOnboardingProfileUseCase(gh<_i205.OnboardingRepository>()));
    gh.factory<_i250.GetRecentActivityUseCase>(
        () => _i250.GetRecentActivityUseCase(gh<_i237.DashboardRepository>()));
    gh.factory<_i251.HealthImportBloc>(() => _i251.HealthImportBloc(
          gh<_i108.GetAvailableSourcesUseCase>(),
          gh<_i108.RequestHealthAuthUseCase>(),
          gh<_i108.ImportHealthDataUseCase>(),
        ));
    gh.factory<_i252.HealthImportCubit>(() => _i252.HealthImportCubit(
          gh<_i108.GetAvailableSourcesUseCase>(),
          gh<_i108.RequestHealthAuthUseCase>(),
          gh<_i108.ImportHealthDataUseCase>(),
        ));
    gh.factory<_i253.HealthRecordCubit>(() => _i253.HealthRecordCubit(
    ...
    gh.lazySingleton<_i254.HomeRepository>(() => _i255.HomeRepositoryImpl(
          gh<_i132.VitalSignRepository>(),
          gh<_i8.AppointmentRepository>(),
          gh<_i199.MedicationRepository>(),
    ...
    gh.lazySingleton<_i257.MedicalResearchRepository>(
        () => _i258.MedicalResearchRepositoryImpl(
              gh<_i198.MedicalResearchService>(),
              gh<_i60.Isar>(),
            ));
    gh.factory<_i259.MedicationBloc>(
        () => _i259.MedicationBloc(gh<_i199.MedicationRepository>()));
    gh.factory<_i260.OnboardingCubit>(
        () => _i260.OnboardingCubit(gh<_i205.OnboardingRepository>()));
    gh.lazySingleton<_i261.PatientContextIndexer>(
      () => _i261.PatientContextIndexer(
        gh<_i60.Isar>(),
        gh<_i130.VectorStoreService>(),
        gh<_i185.HealthRecordRepository>(),
        gh<_i199.MedicationRepository>(),
    ...
    gh.factory<_i262.ReportBloc>(() => _i262.ReportBloc(
          gh<_i106.ReportRepository>(),
          gh<_i207.ReportGenerationService>(),
        ));
    gh.factory<_i263.SaveAllergyUseCase>(
        () => _i263.SaveAllergyUseCase(gh<_i228.AllergyRepository>()));
    gh.factory<_i264.SearchMedicalResearch>(() =>
        _i264.SearchMedicalResearch(gh<_i257.MedicalResearchRepository>()));
    gh.factory<_i265.SharingCubit>(() => _i265.SharingCubit(
    ...
    gh.factory<_i266.AllergiesCubit>(
        () => _i266.AllergiesCubit(gh<_i228.AllergyRepository>()));
    gh.factory<_i267.AllergyBloc>(
        () => _i267.AllergyBloc(gh<_i228.AllergyRepository>()));
    gh.factory<_i268.AuthCubit>(() => _i268.AuthCubit(gh<_i231.AuthService>()));
    gh.factory<_i269.DashboardCubit>(() => _i269.DashboardCubit(
          gh<_i248.GetDashboardStatsUseCase>(),
          gh<_i250.GetRecentActivityUseCase>(),
        ));
    gh.factory<_i270.DataSourceCubit>(
        () => _i270.DataSourceCubit(gh<_i239.DataSourceRepository>()));
    gh.factory<_i271.GetHealthSummaryUseCase>(
        () => _i271.GetHealthSummaryUseCase(gh<_i254.HomeRepository>()));
    gh.factory<_i272.GetResearchHistory>(
        () => _i272.GetResearchHistory(gh<_i257.MedicalResearchRepository>()));
    gh.factory<_i273.HomeCubit>(() => _i273.HomeCubit(
          gh<_i271.GetHealthSummaryUseCase>(),
          gh<_i254.HomeRepository>(),
        ));
    gh.lazySingleton<_i274.MedicalIndexingService>(
        () => _i274.MedicalIndexingService(
              gh<_i69.MedicalKnowledgeRepository>(),
              gh<_i130.VectorStoreService>(),
              gh<_i261.PatientContextIndexer>(),
            ));
    gh.factory<_i275.MedicalResearchCubit>(() => _i275.MedicalResearchCubit(
          gh<_i264.SearchMedicalResearch>(),
          gh<_i272.GetResearchHistory>(),
...
class _$ServiceModule extends _i276.ServiceModule {}

class _$NetworkModule extends _i277.NetworkModule {}

class _$MemoryModule extends _i278.MemoryModule {}

class _$DatabaseModule extends _i279.DatabaseModule {}

class _$FhirModule extends _i280.FhirModule {}
