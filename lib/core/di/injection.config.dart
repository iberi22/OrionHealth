...
import '../../features/about/infrastructure/repositories/about_repository_impl.dart'
    as _i36;
import '../../features/allergies/application/allergies_cubit.dart' as _i169;
...
import '../../features/appointments/infrastructure/repositories/isar_appointment_repository.dart'
    as _i114;
import '../../features/auth/application/auth_cubit.dart' as _i170;
import '../../features/auth/application/bloc/auth_cubit.dart' as _i171;
...
import '../../features/calendar_import/infrastructure/repositories/calendar_repository_impl.dart'
    as _i17;
import '../../features/dashboard/application/dashboard_cubit.dart' as _i175;
...
import '../../features/health_sharing/infrastructure/wifi_direct_service.dart'
    as _i93;
import '../../features/home/application/home_cubit.dart' as _i179;
import '../../features/home/domain/repositories/home_repository.dart' as _i141;
...
import '../../features/local_agent/infrastructure/gemma_llm_service.dart'
    as _i149;
import '../../features/local_agent/infrastructure/llm_service.dart' as _i148;
...
import '../../features/medications/infrastructure/repositories/isar_medication_repository.dart'
    as _i65;
import '../../features/meditation/application/meditation_cubit.dart' as _i152;
...
import '../../features/onboarding/application/sync_cubit.dart' as _i161;
import '../../features/onboarding/domain/repositories/onboarding_repository.dart'
    as _i153;
import '../../features/onboarding/infrastructure/onboarding_repository_impl.dart'
    as _i154;
import '../../features/reports/application/bloc/report_bloc.dart' as _i183;
...
import '../../features/reports/infrastructure/services/mock_report_generation_service.dart'
    as _i70;
import '../../features/settings/application/llm_settings_cubit.dart' as _i150;
...
import '../../features/settings/infrastructure/repositories/llm_settings_repository_impl.dart'
    as _i51;
import '../../features/sync/application/sync_cubit.dart' as _i176;
import '../../features/sync/domain/repositories/sync_repository.dart' as _i164;
import '../../features/sync/domain/services/sync_service.dart' as _i162;
import '../../features/sync/domain/sync_repository.dart' as _i95;
import '../../features/sync/domain/sync_service.dart' as _i165;
...
import '../../features/vitals/infrastructure/repositories/vital_sign_repository_impl.dart'
    as _i104;
import '../../features/voice_chat/application/voice_chat_cubit.dart' as _i167;
...
import 'calendar_module.dart' as _i185;
import 'database_module.dart' as _i188;
import 'fhir_module.dart' as _i184;
import 'memory_module.dart' as _i187;
import 'network_module.dart' as _i186;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i130.GetProgressUseCase>(
        () => _i130.GetProgressUseCase(gh<_i68.MeditationRepository>()));
    gh.lazySingleton<_i131.GetScriptsUseCase>(
        () => _i131.GetScriptsUseCase(gh<_i68.MeditationRepository>()));
    gh.lazySingleton<_i132.GovernanceIpfsDatasource>(
        () => _i132.GovernanceIpfsDatasource(gh<_i41.IpfsDatasource>()));
    gh.lazySingleton<_i133.GovernanceRepository>(() =>
        _i134.GovernanceRepositoryImpl(gh<_i132.GovernanceIpfsDatasource>()));
    gh.lazySingleton<_i135.HealthDataFileDataSource>(
        () => _i135.HealthDataFileDataSource(
              gh<_i29.FilePickerService>(),
              gh<_i80.OcrService>(),
            ));
    gh.lazySingleton<_i136.HealthDataRepository>(
        () => _i136.HealthDataRepositoryImpl(
              gh<_i90.SensorHealthDataSource>(),
              gh<_i90.FileHealthDataSource>(),
            ));
    gh.factory<_i137.HealthImportCubit>(() => _i137.HealthImportCubit(
          gh<_i31.HealthDataImportService>(),
          gh<_i103.VitalSignRepository>(),
        ));
    gh.lazySingleton<_i138.HealthRecordRepository>(
        () => _i139.HealthRecordRepositoryImpl(gh<_i43.Isar>()));
    gh.lazySingleton<_i140.HealthSharingLocalDataSource>(
        () => _i140.HealthSharingLocalDataSource(gh<_i43.Isar>()));
    gh.lazySingleton<_i141.HomeRepository>(() => _i142.HomeRepositoryImpl(
          gh<_i103.VitalSignRepository>(),
          gh<_i113.AppointmentRepository>(),
          gh<_i64.MedicationRepository>(),
        ));
    gh.factory<_i143.ImportCalendarUseCase>(() => _i143.ImportCalendarUseCase(
          gh<_i16.CalendarRepository>(),
          gh<_i113.AppointmentRepository>(),
          gh<_i98.UserProfileRepository>(),
        ));
    gh.factory<_i46.LlmAdapter>(
      () => _i144.MockLlmAdapter(gh<_i82.PromptScrubber>()),
      instanceName: 'mock',
    );
    gh.lazySingleton<_i46.LlmAdapter>(
      () => _i145.GeminiLlmAdapter(
        scrubber: gh<_i82.PromptScrubber>(),
        userProfileRepository: gh<_i98.UserProfileRepository>(),
        modelWrapper: gh<_i146.GeminiModelWrapper>(),
      ),
      instanceName: 'gemini',
    );
    gh.lazySingleton<_i147.LlmAdapterFactory>(
        () => _i147.LlmAdapterFactory(gh<_i50.LlmSettingsRepository>()));
    gh.lazySingleton<_i148.LlmService>(() => _i149.GemmaLlmService(
          gh<_i101.VectorStoreService>(),
          gh<_i98.UserProfileRepository>(),
          gh<_i46.LlmAdapter>(instanceName: 'gemma'),
        ));
    gh.factory<_i150.LlmSettingsCubit>(() => _i150.LlmSettingsCubit(
          gh<_i50.LlmSettingsRepository>(),
          gh<_i21.DeviceCapabilityService>(),
          gh<_i46.LlmAdapter>(instanceName: 'gemma'),
        ));
    gh.lazySingleton<_i151.MedicalResearchService>(
        () => _i151.MedicalResearchService(
              gh<_i62.MedicalWebSearchService>(),
              gh<_i58.MedicalScraperService>(),
            ));
    gh.factory<_i152.MeditationCubit>(() => _i152.MeditationCubit(
          gh<_i85.RecommendScriptUseCase>(),
          gh<_i94.StartSessionUseCase>(),
          gh<_i120.CompleteSessionUseCase>(),
          gh<_i130.GetProgressUseCase>(),
          gh<_i9.AudioService>(),
        ));
    gh.lazySingleton<_i153.OnboardingRepository>(
        () => _i154.OnboardingRepositoryImpl(gh<_i98.UserProfileRepository>()));
    gh.lazySingleton<_i155.PatientContextIndexer>(
      () => _i155.PatientContextIndexer(
        gh<_i43.Isar>(),
        gh<_i101.VectorStoreService>(),
        gh<_i138.HealthRecordRepository>(),
        gh<_i64.MedicationRepository>(),
    ...
    gh.lazySingleton<_i156.ReportGenerationService>(
        () => _i157.GemmaReportGenerationService(
              gh<_i46.LlmAdapter>(instanceName: 'gemma'),
              gh<_i101.VectorStoreService>(),
              gh<_i98.UserProfileRepository>(),
              gh<_i82.PromptScrubber>(),
            ));
    gh.factory<_i158.SecondOpinionCubit>(
        () => _i158.SecondOpinionCubit(gh<_i88.SecondOpinionRepository>()));
    gh.factory<_i159.SendMessageUseCase>(
        () => _i159.SendMessageUseCase(gh<_i106.VoiceChatRepository>()));
    gh.lazySingleton<_i160.SmartSearchUseCase>(
        () => _i160.SmartSearchUseCase(gh<_i101.VectorStoreService>()));
    gh.factory<_i161.SyncCubit>(() => _i161.SyncCubit(
          gh<_i54.SyncService>(),
          gh<_i101.VectorStoreService>(),
        ));
    gh.lazySingleton<_i162.SyncService>(() => _i163.SyncServiceImpl(
          gh<_i164.SyncRepository>(),
          gh<_i54.SyncService>(),
        ));
    gh.lazySingleton<_i165.SyncService>(() => _i165.SyncService(
          gh<_i95.SyncRepository>(),
          gh<_i98.UserProfileRepository>(),
        ));
    gh.factory<_i166.UserProfileCubit>(
        () => _i166.UserProfileCubit(gh<_i98.UserProfileRepository>()));
    gh.factory<_i167.VoiceChatCubit>(() => _i167.VoiceChatCubit(
          gh<_i159.SendMessageUseCase>(),
          gh<_i129.GetChatHistoryUseCase>(),
          gh<_i106.VoiceChatRepository>(),
          gh<_i9.AudioService>(),
        ));
    gh.factory<_i168.VouchCubit>(
        () => _i168.VouchCubit(gh<_i108.VouchRepository>()));
    gh.factory<_i169.AllergiesCubit>(
        () => _i169.AllergiesCubit(gh<_i111.AllergyRepository>()));
    gh.factory<_i170.AuthCubit>(() => _i170.AuthCubit(gh<_i118.AuthService>()));
    gh.factory<_i171.AuthCubit>(() => _i171.AuthCubit(
          gh<_i116.AuthRepository>(),
          gh<_i27.EncryptionService>(),
          gh<_i10.BiometricService>(),
        ));
    gh.lazySingleton<_i172.BadgeCalculator>(() => _i172.BadgeCalculator(
          gh<_i124.DoctorProfileRepository>(),
          gh<_i83.RatingRepository>(),
          gh<_i108.VouchRepository>(),
        ));
    gh.factory<_i173.BadgeCubit>(
        () => _i173.BadgeCubit(gh<_i172.BadgeCalculator>()));
    gh.factory<_i174.CalendarImportCubit>(() => _i174.CalendarImportCubit(
          gh<_i16.CalendarRepository>(),
          gh<_i143.ImportCalendarUseCase>(),
        ));
    gh.factory<_i175.DashboardCubit>(
        () => _i175.DashboardCubit(gh<_i121.DashboardRepository>()));
    gh.factory<_i176.FhirSyncCubit>(() => _i176.FhirSyncCubit(
          gh<_i162.SyncService>(),
          gh<_i74.NodeDiscoveryService>(),
        ));
    gh.factory<_i177.GetHealthSummaryUseCase>(
        () => _i177.GetHealthSummaryUseCase(gh<_i141.HomeRepository>()));
    gh.factory<_i178.HealthRecordCubit>(() => _i178.HealthRecordCubit(
          gh<_i138.HealthRecordRepository>(),
          gh<_i29.FilePickerService>(),
    ...
    gh.factory<_i179.HomeCubit>(() => _i179.HomeCubit(
          gh<_i177.GetHealthSummaryUseCase>(),
          gh<_i141.HomeRepository>(),
        ));
    gh.lazySingleton<_i148.LlmService>(
      () => _i180.RagLlmService(
        gh<_i101.VectorStoreService>(),
        gh<_i151.MedicalResearchService>(),
        gh<_i98.UserProfileRepository>(),
        gh<_i46.LlmAdapter>(instanceName: 'gemma'),
      ),
      instanceName: 'rag',
    );
    gh.lazySingleton<_i181.MedicalIndexingService>(
        () => _i181.MedicalIndexingService(
              gh<_i55.MedicalKnowledgeRepository>(),
              gh<_i101.VectorStoreService>(),
              gh<_i155.PatientContextIndexer>(),
            ));
    gh.factory<_i182.MedicalResearchCubit>(() => _i182.MedicalResearchCubit(
          gh<_i151.MedicalResearchService>(),
          gh<_i60.MedicalStandardsService>(),
        ));
    gh.factory<_i183.ReportBloc>(() => _i183.ReportBloc(
          gh<_i86.ReportRepository>(),
          gh<_i156.ReportGenerationService>(),
        ));
    return this;
  }
}

class _$FhirModule extends _i184.FhirModule {}

class _$CalendarModule extends _i185.CalendarModule {}

class _$NetworkModule extends _i186.NetworkModule {}

class _$MemoryModule extends _i187.MemoryModule {}
