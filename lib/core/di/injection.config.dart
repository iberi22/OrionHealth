...
import 'package:flutter_appauth/flutter_appauth.dart' as _i51;
...
import '../../features/appointments/infrastructure/repositories/isar_appointment_repository.dart'
    as _i83;
import '../../features/auth/application/auth_cubit.dart' as _i114;
import '../../features/auth/application/bloc/auth_cubit.dart' as _i113;
import '../../features/auth/domain/auth_service.dart' as _i86;
import '../../features/auth/domain/repositories/auth_repository.dart' as _i84;
...
import '../../features/doctor_verification/domain/services/license_verifier.dart'
    as _i24;
import '../../features/eps_connection/domain/eps_connection_cubit.dart' as _i91;
...
import '../../features/health_record/infrastructure/services/ocr_service.dart'
    as _i53;
import '../../features/health_sharing/application/sharing_cubit.dart' as _i60;
...
import '../../features/local_agent/infrastructure/gemma_llm_service.dart'
    as _i103;
import '../../features/local_agent/infrastructure/llm_service.dart' as _i102;
...
import '../../features/onboarding/application/sync_cubit.dart' as _i111;
import '../../features/reports/application/bloc/report_bloc.dart' as _i118;
...
import '../../features/reports/infrastructure/services/mock_report_generation_service.dart'
    as _i47;
import '../../features/settings/application/llm_settings_cubit.dart' as _i104;
...
import '../../features/settings/infrastructure/repositories/llm_settings_repository_impl.dart'
    as _i30;
import '../../features/ssi/domain/repositories/ssi_repository.dart' as _i63;
import '../../features/ssi/domain/services/anoncreds_service.dart' as _i80;
import '../../features/ssi/domain/services/ssi_service.dart' as _i65;
...
import '../../features/sync/data/sync_repository.dart' as _i68;
import '../../features/sync/domain/sync_cubit.dart' as _i92;
...
import '../services/privacy_anonymizer.dart' as _i55;
import 'database_module.dart' as _i122;
import 'fhir_module.dart' as _i119;
import 'memory_module.dart' as _i121;
import 'network_module.dart' as _i120;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i35.MedicalKnowledgeRepository>(
      () => _i36.JsonMedicalKnowledgeRepository(),
      registerFor: {
        _desktop,
        _test,
      },
    ...
    gh.factory<_i35.MedicalKnowledgeRepository>(
      () => _i37.AssetMedicalKnowledgeRepository(),
      registerFor: {_mobile},
    );
    ...
    gh.lazySingleton<_i49.NfcSharingService>(() => _i49.NfcSharingService());
    gh.lazySingleton<_i50.OAuthRepository>(() => _i50.OAuthRepositoryImpl(
          appAuth: gh<_i51.FlutterAppAuth>(),
          secureStorage: gh<_i52.FlutterSecureStorage>(),
          clientId: gh<String>(),
    ...
    gh.lazySingleton<_i53.OcrService>(() => _i53.MlKitOcrService());
    gh.factory<_i54.OnboardingCubit>(() => _i54.OnboardingCubit());
    gh.lazySingleton<_i55.PromptScrubber>(
        () => _i55.PromptScrubber(gh<_i20.Isar>()));
    gh.lazySingleton<_i56.ReportRepository>(
        () => _i57.IsarReportRepository(gh<_i20.Isar>()));
    gh.factory<_i58.RiskCalculator>(() => _i58.RiskCalculator());
    gh.factory<_i59.RiskCalculatorService>(() =>
        _i59.RiskCalculatorService(calculator: gh<_i58.RiskCalculator>()));
    gh.factory<_i60.SharingCubit>(() => _i60.SharingCubit(
          bleService: gh<_i6.BleSharingService>(),
          nfcService: gh<_i49.NfcSharingService>(),
          wifiService: gh<_i61.WifiDirectService>(),
        ));
    gh.lazySingleton<_i62.SidetreeAnchorClient>(
        () => _i62.SidetreeAnchorClient.create());
    gh.lazySingleton<_i63.SsiRepository>(
        () => _i64.IsarSsiRepository(gh<_i20.Isar>()));
    gh.lazySingleton<_i65.SsiService>(() => _i66.SsiServiceImpl(
          gh<_i63.SsiRepository>(),
          gh<_i62.SidetreeAnchorClient>(),
        ));
    gh.factory<_i67.SymptomAnalysisStrategy>(
        () => _i67.SymptomAnalysisStrategy());
    gh.lazySingleton<_i68.SyncRepository>(() => _i68.SyncRepository(
          gh<_i16.FhirClient>(),
          gh<_i20.Isar>(),
    ...
    gh.lazySingleton<_i69.UserProfileRepository>(
        () => _i70.UserProfileRepositoryImpl(gh<_i20.Isar>()));
    gh.lazySingleton<_i71.UserProfileService>(
        () => _i71.UserProfileService(gh<_i69.UserProfileRepository>()));
    gh.lazySingleton<_i72.VectorStoreService>(() => _i73.IsarVectorStoreService(
          gh<_i14.MemoryGraph>(),
          gh<_i35.MedicalKnowledgeRepository>(),
        ));
    gh.factory<_i74.VitalAnalysisStrategy>(() => _i74.VitalAnalysisStrategy());
    gh.factory<_i75.VitalSignAnalyzer>(() => _i75.VitalSignAnalyzer());
    gh.lazySingleton<_i76.VitalSignRepository>(
        () => _i77.VitalSignRepositoryImpl(gh<_i20.Isar>()));
    gh.lazySingleton<_i61.WifiDirectService>(() => _i61.WifiDirectService());
    gh.lazySingleton<_i78.AllergyRepository>(
        () => _i79.IsarAllergyRepository(gh<_i20.Isar>()));
    gh.lazySingleton<_i80.AnonCredsService>(
        () => _i81.AnonCredsServiceImpl(gh<_i63.SsiRepository>()));
    gh.lazySingleton<_i82.AppointmentRepository>(
        () => _i83.IsarAppointmentRepository(gh<_i20.Isar>()));
    gh.lazySingleton<_i84.AuthRepository>(
        () => _i85.AuthRepositoryImpl(gh<_i20.Isar>()));
    gh.lazySingleton<_i86.AuthService>(
        () => _i86.AuthServiceImpl(gh<_i15.EncryptionService>()));
    gh.lazySingleton<_i87.BleMedicalSharingService>(
        () => _i87.BleMedicalSharingService(
              gh<_i6.BleSharingService>(),
              gh<_i15.EncryptionService>(),
              gh<_i65.SsiService>(),
            ));
    gh.factory<_i88.CalendarImportCubit>(() => _i88.CalendarImportCubit(
          gh<_i9.CalendarRepository>(),
          gh<_i82.AppointmentRepository>(),
          gh<_i69.UserProfileRepository>(),
        ));
    gh.lazySingleton<_i89.ClinicalReasonerService>(
        () => _i90.SymphonyClinicalReasonerService(
              gh<_i35.MedicalKnowledgeRepository>(),
              gh<_i55.PromptScrubber>(),
            ));
    gh.factory<_i91.EpsConnectionCubit>(() => _i91.EpsConnectionCubit(
          gh<_i50.OAuthRepository>(),
          gh<_i69.UserProfileRepository>(),
        ));
    gh.factory<_i92.FhirSyncCubit>(
        () => _i92.FhirSyncCubit(gh<_i68.SyncRepository>()));
    gh.lazySingleton<_i93.HealthContextService>(
        () => _i94.IsarHealthContextService(
    ...
    gh.lazySingleton<_i96.HealthRecordRepository>(
        () => _i97.HealthRecordRepositoryImpl(gh<_i20.Isar>()));
    gh.lazySingleton<_i25.LlmAdapter>(
      () => _i98.GeminiLlmAdapter(
        scrubber: gh<_i55.PromptScrubber>(),
        userProfileRepository: gh<_i69.UserProfileRepository>(),
        modelWrapper: gh<_i99.GeminiModelWrapper>(),
      ),
      instanceName: 'gemini',
    );
    gh.factory<_i25.LlmAdapter>(
      () => _i100.MockLlmAdapter(gh<_i55.PromptScrubber>()),
      instanceName: 'mock',
    );
    gh.lazySingleton<_i101.LlmAdapterFactory>(
        () => _i101.LlmAdapterFactory(gh<_i29.LlmSettingsRepository>()));
    gh.lazySingleton<_i102.LlmService>(() => _i103.GemmaLlmService(
          gh<_i72.VectorStoreService>(),
          gh<_i69.UserProfileRepository>(),
          gh<_i25.LlmAdapter>(instanceName: 'gemma'),
        ));
    gh.factory<_i104.LlmSettingsCubit>(() => _i104.LlmSettingsCubit(
          gh<_i29.LlmSettingsRepository>(),
          gh<_i12.DeviceCapabilityService>(),
          gh<_i25.LlmAdapter>(instanceName: 'gemma'),
        ));
    gh.factory<_i105.MedicalAssistantCubit>(() => _i105.MedicalAssistantCubit(
          llmAdapter: gh<_i38.MedicalLlmAdapter>(),
          analysisService: gh<_i32.MedicalAnalysisService>(),
          healthContextService: gh<_i93.HealthContextService>(),
        ));
    gh.lazySingleton<_i106.MedicalResearchService>(
        () => _i106.MedicalResearchService(
              gh<_i43.MedicalWebSearchService>(),
              gh<_i39.MedicalScraperService>(),
            ));
    gh.lazySingleton<_i107.PatientContextIndexer>(
      () => _i107.PatientContextIndexer(
        gh<_i20.Isar>(),
        gh<_i72.VectorStoreService>(),
        gh<_i96.HealthRecordRepository>(),
        gh<_i45.MedicationRepository>(),
        gh<_i78.AllergyRepository>(),
        gh<_i76.VitalSignRepository>(),
        gh<_i82.AppointmentRepository>(),
      ),
      dispose: (i) => i.dispose(),
    );
    gh.lazySingleton<_i108.ReportGenerationService>(
        () => _i109.GemmaReportGenerationService(
              gh<_i25.LlmAdapter>(instanceName: 'gemma'),
              gh<_i72.VectorStoreService>(),
              gh<_i69.UserProfileRepository>(),
              gh<_i55.PromptScrubber>(),
            ));
    gh.lazySingleton<_i110.SmartSearchUseCase>(
        () => _i110.SmartSearchUseCase(gh<_i72.VectorStoreService>()));
    gh.factory<_i111.SyncCubit>(() => _i111.SyncCubit(
          gh<_i33.SyncService>(),
          gh<_i72.VectorStoreService>(),
        ));
    gh.factory<_i112.UserProfileCubit>(
        () => _i112.UserProfileCubit(gh<_i69.UserProfileRepository>()));
    gh.factory<_i113.AuthCubit>(() => _i113.AuthCubit(
          gh<_i84.AuthRepository>(),
          gh<_i15.EncryptionService>(),
          gh<_i5.BiometricService>(),
        ));
    gh.factory<_i114.AuthCubit>(() => _i114.AuthCubit(gh<_i86.AuthService>()));
    gh.factory<_i115.HealthRecordCubit>(() => _i115.HealthRecordCubit(
          gh<_i96.HealthRecordRepository>(),
    ...
    gh.lazySingleton<_i102.LlmService>(
      () => _i116.RagLlmService(
        gh<_i72.VectorStoreService>(),
        gh<_i106.MedicalResearchService>(),
        gh<_i69.UserProfileRepository>(),
        gh<_i25.LlmAdapter>(instanceName: 'gemma'),
      ),
      instanceName: 'rag',
    );
    gh.lazySingleton<_i117.MedicalIndexingService>(
        () => _i117.MedicalIndexingService(
              gh<_i35.MedicalKnowledgeRepository>(),
              gh<_i72.VectorStoreService>(),
              gh<_i107.PatientContextIndexer>(),
            ));
    gh.factory<_i118.ReportBloc>(() => _i118.ReportBloc(
          gh<_i56.ReportRepository>(),
          gh<_i108.ReportGenerationService>(),
        ));
    return this;
  }
}

class _$FhirModule extends _i119.FhirModule {}

class _$NetworkModule extends _i120.NetworkModule {}

class _$MemoryModule extends _i121.MemoryModule {}

class _$DatabaseModule extends _i122.DatabaseModule {}
