...
import '../../features/health_sharing/infrastructure/health_sharing_module.dart'
    as _i193;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    final healthSharingModule = _$HealthSharingModule();
    ...
    gh.lazySingleton<_i70.MethodChannel>(
      () => healthSharingModule.nfcChannel,
      instanceName: 'nfcChannel',
    );
    ...
    gh.factory<_i73.NfcHandler>(() =>
        _i73.NfcHandler(gh<_i70.MethodChannel>(instanceName: 'nfcChannel')));
    gh.lazySingleton<_i74.NfcSharingService>(
        () => _i74.NfcSharingService(gh<_i73.NfcHandler>()));
...
class _$HealthSharingModule extends _i193.HealthSharingModule {}
