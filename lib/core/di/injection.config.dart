...
import '../../features/appointments/infrastructure/repositories/isar_appointment_repository.dart'
    as _i60;
import '../../features/auth/application/auth_cubit.dart' as _i85;
import '../../features/auth/application/bloc/auth_cubit.dart' as _i86;
...
import '../../features/eps_connection/domain/eps_connection_cubit.dart' as _i67;
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i65.ClinicalReasonerService>(() =>
        _i66.SymphonyClinicalReasonerService(
            gh<_i23.MedicalKnowledgeRepository>()));
    gh.factory<_i67.EpsConnectionCubit>(() => _i67.EpsConnectionCubit(
    ...
    gh.factory<_i16.LlmAdapter>(
      () => _i74.MockLlmAdapter(gh<_i39.PromptScrubber>()),
      instanceName: 'mock',
    );
    ...
    gh.factory<_i85.AuthCubit>(() => _i85.AuthCubit(gh<_i63.AuthService>()));
    gh.factory<_i86.AuthCubit>(() => _i86.AuthCubit(
