...
import '../../features/about/application/about_cubit.dart' as _i118;
...
import '../../features/auth/domain/auth_service.dart' as _i127;
import '../../features/auth/domain/repositories/auth_repository.dart' as _i125;
...
import '../../features/email-citas/application/bloc/email_citas_bloc.dart'
    as _i143;
import '../../features/email-citas/application/email_citas_cubit.dart' as _i144;
...
import '../../features/sync/domain/repositories/sync_repository.dart' as _i102;
...
import '../../features/sync/infrastructure/services/ipfs_service.dart' as _i139;
...
import '../../features/vitals/application/vitals_cubit.dart' as _i112;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i46.HomeRemoteDataSource>(
        () => _i46.HomeRemoteDataSource(gh<_i25.Dio>()));
    ...
    gh.lazySingleton<_i100.StartSessionUseCase>(
        () => _i100.StartSessionUseCase(gh<_i76.MeditationRepository>()));
    gh.factory<_i101.SyncEmailAppointmentsUseCase>(
        () => _i101.SyncEmailAppointmentsUseCase(gh<_i26.EmailRepository>()));
    gh.lazySingleton<_i102.SyncRepository>(() => _i103.SyncRepositoryImpl(
          gh<_i31.FhirClient>(),
          gh<_i54.Isar>(),
    ...
    gh.lazySingleton<_i104.UserProfileLocalDataSource>(
        () => _i104.UserProfileLocalDataSource(gh<_i54.Isar>()));
    gh.lazySingleton<_i105.UserProfileRepository>(
        () => _i106.UserProfileRepositoryImpl(gh<_i54.Isar>()));
    gh.lazySingleton<_i107.UserProfileService>(
        () => _i107.UserProfileService(gh<_i105.UserProfileRepository>()));
    gh.lazySingleton<_i108.VectorStoreService>(
        () => _i109.IsarVectorStoreService(
              gh<_i28.MemoryGraph>(),
              gh<_i63.MedicalKnowledgeRepository>(),
            ));
    gh.lazySingleton<_i110.VitalSignRepository>(
        () => _i111.VitalSignRepositoryImpl(gh<_i54.Isar>()));
    gh.factory<_i112.VitalsCubit>(
        () => _i112.VitalsCubit(gh<_i110.VitalSignRepository>()));
    gh.lazySingleton<_i113.VoiceChatRepository>(
        () => _i114.VoiceChatRepositoryImpl(gh<_i20.ChatAiDatasource>()));
    gh.lazySingleton<_i115.VouchRepository>(
        () => _i116.IsarVouchRepository(gh<_i54.Isar>()));
    gh.lazySingleton<_i29.WalletService>(() => databaseModule.walletService(
          gh<_i54.Isar>(),
          gh<_i29.EncryptionService>(),
        ));
    gh.lazySingleton<_i117.WifiDirectService>(() => _i117.WifiDirectService());
    gh.factory<_i118.AboutCubit>(
        () => _i118.AboutCubit(gh<_i47.IAboutRepository>()));
    gh.lazySingleton<_i119.AboutRemoteDataSource>(
        () => _i119.AboutRemoteDataSource(gh<_i25.Dio>()));
    gh.lazySingleton<_i120.AllergyRepository>(
        () => _i121.IsarAllergyRepository(gh<_i54.Isar>()));
    gh.lazySingleton<_i122.AppointmentRepository>(
        () => _i123.IsarAppointmentRepository(gh<_i54.Isar>()));
    gh.factory<_i124.AppointmentsCubit>(
        () => _i124.AppointmentsCubit(gh<_i122.AppointmentRepository>()));
    gh.lazySingleton<_i125.AuthRepository>(
        () => _i126.AuthRepositoryImpl(gh<_i54.Isar>()));
    gh.lazySingleton<_i127.AuthService>(
        () => _i127.AuthServiceImpl(gh<_i30.EncryptionService>()));
    gh.lazySingleton<_i128.BleSharingService>(
        () => _i128.BleSharingService(gh<_i12.BleWrapper>()));
    gh.lazySingleton<_i129.CancelSharingUseCase>(
        () => _i129.CancelSharingUseCase(
              gh<_i128.BleSharingService>(),
              gh<_i82.NfcSharingService>(),
              gh<_i117.WifiDirectService>(),
            ));
    gh.lazySingleton<_i130.ChatMessageLocalDataSource>(
        () => _i130.ChatMessageLocalDataSource(gh<_i54.Isar>()));
    gh.lazySingleton<_i131.CompleteSessionUseCase>(
        () => _i131.CompleteSessionUseCase(gh<_i76.MeditationRepository>()));
    gh.factory<_i101.ConnectEmailProviderUseCase>(
        () => _i101.ConnectEmailProviderUseCase(gh<_i26.EmailRepository>()));
    gh.factory<_i132.ConnectProviderUseCase>(() => _i132.ConnectProviderUseCase(
          gh<_i86.OAuthRepository>(),
          gh<_i105.UserProfileRepository>(),
        ));
    gh.lazySingleton<_i133.DashboardLocalDataSource>(
        () => _i133.DashboardLocalDataSource(gh<_i54.Isar>()));
    gh.lazySingleton<_i134.DashboardRepository>(
        () => _i135.DashboardRepositoryImpl(
              gh<_i133.DashboardLocalDataSource>(),
              gh<_i22.DashboardRemoteDataSource>(),
              gh<_i110.VitalSignRepository>(),
              gh<_i72.MedicationRepository>(),
              gh<_i93.ReportRepository>(),
            ));
    gh.factory<_i136.DeleteAppointmentUseCase>(() =>
        _i136.DeleteAppointmentUseCase(gh<_i122.AppointmentRepository>()));
    gh.factory<_i137.DisconnectProviderUseCase>(
        () => _i137.DisconnectProviderUseCase(
              gh<_i86.OAuthRepository>(),
              gh<_i105.UserProfileRepository>(),
            ));
    gh.lazySingleton<_i138.DistributedStorageService>(() => _i139.IpfsService(
          gh<_i53.IpfsDatasource>(),
          gh<_i33.FilecoinDatasource>(),
        ));
    gh.lazySingleton<_i140.DoctorProfileRepository>(
        () => _i141.IsarDoctorProfileRepository(gh<_i54.Isar>()));
    gh.factoryAsync<_i142.DoctorVerificationCubit>(
        () async => _i142.DoctorVerificationCubit(
              gh<_i140.DoctorProfileRepository>(),
              gh<_i90.RatingRepository>(),
              await getAsync<_i56.LicenseVerifier>(),
            ));
    gh.factory<_i143.EmailCitasBloc>(() => _i143.EmailCitasBloc(
          gh<_i101.ConnectEmailProviderUseCase>(),
          gh<_i101.SyncEmailAppointmentsUseCase>(),
          gh<_i26.EmailRepository>(),
          gh<_i122.AppointmentRepository>(),
        ));
    gh.factory<_i144.EmailCitasCubit>(() => _i144.EmailCitasCubit(
          gh<_i26.EmailRepository>(),
          gh<_i122.AppointmentRepository>(),
        ));
    ...
    gh.factory<_i145.GetAllAppointmentsUseCase>(() =>
        _i145.GetAllAppointmentsUseCase(gh<_i122.AppointmentRepository>()));
    gh.factory<_i95.GetAvailableSourcesUseCase>(() =>
        _i95.GetAvailableSourcesUseCase(gh<_i39.HealthDataImportService>()));
    gh.factory<_i146.GetChatHistoryUseCase>(
        () => _i146.GetChatHistoryUseCase(gh<_i113.VoiceChatRepository>()));
    gh.factory<_i147.GetConnectionsUseCase>(
        () => _i147.GetConnectionsUseCase(gh<_i86.OAuthRepository>()));
    gh.factory<_i148.GetDashboardStatsUseCase>(
        () => _i148.GetDashboardStatsUseCase(gh<_i134.DashboardRepository>()));
    gh.lazySingleton<_i149.GetProgressUseCase>(
        () => _i149.GetProgressUseCase(gh<_i76.MeditationRepository>()));
    gh.factory<_i150.GetRecentActivityUseCase>(
        () => _i150.GetRecentActivityUseCase(gh<_i134.DashboardRepository>()));
    gh.lazySingleton<_i151.GetScriptsUseCase>(
        () => _i151.GetScriptsUseCase(gh<_i76.MeditationRepository>()));
    gh.lazySingleton<_i152.GovernanceIpfsDatasource>(
        () => _i152.GovernanceIpfsDatasource(gh<_i53.IpfsDatasource>()));
    gh.lazySingleton<_i153.GovernanceRepository>(() =>
        _i154.GovernanceRepositoryImpl(gh<_i152.GovernanceIpfsDatasource>()));
    gh.lazySingleton<_i155.HealthDataFileDataSource>(
        () => _i155.HealthDataFileDataSource(
              gh<_i32.FilePickerService>(),
              gh<_i88.OcrService>(),
            ));
    gh.lazySingleton<_i156.HealthDataImportRepository>(
        () => _i157.HealthDataImportRepositoryImpl(
              gh<_i98.SensorHealthDataSource>(),
              gh<_i98.FileHealthDataSource>(),
            ));
    gh.factory<_i158.HealthImportBloc>(() => _i158.HealthImportBloc(
          gh<_i95.GetAvailableSourcesUseCase>(),
          gh<_i95.RequestHealthAuthUseCase>(),
          gh<_i39.HealthDataImportService>(),
          gh<_i110.VitalSignRepository>(),
        ));
    gh.factory<_i159.HealthImportCubit>(() => _i159.HealthImportCubit(
          gh<_i39.HealthDataImportService>(),
          gh<_i110.VitalSignRepository>(),
        ));
    gh.lazySingleton<_i160.HealthRecordRepository>(
        () => _i161.HealthRecordRepositoryImpl(gh<_i54.Isar>()));
    ...
    gh.factory<_i172.MedicationBloc>(
        () => _i172.MedicationBloc(gh<_i72.MedicationRepository>()));
    gh.factory<_i173.MeditationCubit>(() => _i173.MeditationCubit(
          gh<_i92.RecommendScriptUseCase>(),
          gh<_i100.StartSessionUseCase>(),
          gh<_i131.CompleteSessionUseCase>(),
          gh<_i149.GetProgressUseCase>(),
          gh<_i8.AudioService>(),
        ));
    gh.lazySingleton<_i174.OnboardingRepository>(() =>
        _i175.OnboardingRepositoryImpl(gh<_i105.UserProfileRepository>()));
    gh.lazySingleton<_i176.PatientContextIndexer>(
      () => _i176.PatientContextIndexer(
        gh<_i54.Isar>(),
        gh<_i108.VectorStoreService>(),
        gh<_i160.HealthRecordRepository>(),
        gh<_i72.MedicationRepository>(),
        gh<_i120.AllergyRepository>(),
        gh<_i110.VitalSignRepository>(),
        gh<_i122.AppointmentRepository>(),
      ),
      dispose: (i) => i.dispose(),
    ...
    gh.factory<_i179.SaveAppointmentUseCase>(
        () => _i179.SaveAppointmentUseCase(gh<_i122.AppointmentRepository>()));
    gh.factory<_i180.SecondOpinionCubit>(
        () => _i180.SecondOpinionCubit(gh<_i96.SecondOpinionRepository>()));
    gh.factory<_i181.SendMessageUseCase>(
        () => _i181.SendMessageUseCase(gh<_i113.VoiceChatRepository>()));
    gh.lazySingleton<_i182.SmartSearchUseCase>(
        () => _i182.SmartSearchUseCase(gh<_i108.VectorStoreService>()));
    ...
    gh.lazySingleton<_i186.SyncService>(() => _i187.SyncServiceImpl(
          gh<_i102.SyncRepository>(),
          gh<_i62.SyncService>(),
        ));
    gh.factory<_i188.UserProfileCubit>(
        () => _i188.UserProfileCubit(gh<_i105.UserProfileRepository>()));
    gh.factory<_i189.VitalSignBloc>(
        () => _i189.VitalSignBloc(gh<_i110.VitalSignRepository>()));
    gh.factory<_i190.VoiceChatCubit>(() => _i190.VoiceChatCubit(
          gh<_i181.SendMessageUseCase>(),
          gh<_i146.GetChatHistoryUseCase>(),
          gh<_i113.VoiceChatRepository>(),
          gh<_i8.AudioService>(),
        ));
    gh.factory<_i191.VouchCubit>(
        () => _i191.VouchCubit(gh<_i115.VouchRepository>()));
    gh.factory<_i192.AllergiesCubit>(
        () => _i192.AllergiesCubit(gh<_i120.AllergyRepository>()));
    gh.factory<_i193.AllergyBloc>(
        () => _i193.AllergyBloc(gh<_i120.AllergyRepository>()));
    gh.factory<_i194.AppointmentBloc>(
        () => _i194.AppointmentBloc(gh<_i122.AppointmentRepository>()));
    gh.factory<_i195.AuthCubit>(() => _i195.AuthCubit(
          gh<_i125.AuthRepository>(),
          gh<_i30.EncryptionService>(),
          gh<_i11.BiometricService>(),
        ));
    gh.factory<_i196.AuthCubit>(() => _i196.AuthCubit(gh<_i127.AuthService>()));
    gh.lazySingleton<_i197.BadgeCalculator>(() => _i197.BadgeCalculator(
          gh<_i140.DoctorProfileRepository>(),
          gh<_i90.RatingRepository>(),
          gh<_i115.VouchRepository>(),
        ));
    ...
    gh.factory<_i200.DashboardCubit>(() => _i200.DashboardCubit(
          gh<_i148.GetDashboardStatsUseCase>(),
          gh<_i150.GetRecentActivityUseCase>(),
        ));
    gh.lazySingleton<_i201.DistributedCacheUsecase>(() =>
        _i201.DistributedCacheUsecase(gh<_i138.DistributedStorageService>()));
    gh.factory<_i202.EpsConnectionBloc>(() => _i202.EpsConnectionBloc(
          gh<_i147.GetConnectionsUseCase>(),
          gh<_i132.ConnectProviderUseCase>(),
          gh<_i137.DisconnectProviderUseCase>(),
        ));
