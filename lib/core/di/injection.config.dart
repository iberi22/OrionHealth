...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i181.HealthConnectDataSource>(
        () => _i181.HealthConnectDataSourceImpl(gh<_i49.HealthWrapper>()));
    ...
    gh.lazySingleton<_i189.LlmAdapterFactory>(
        () => _i189.LlmAdapterFactory(gh<_i118.SettingsRepository>()));
    ...
    gh.factory<_i194.LogoutUseCase>(
        () => _i194.LogoutUseCase(gh<_i144.AuthRepository>()));
    ...
    gh.lazySingleton<_i202.OnboardingRepository>(() =>
        _i203.OnboardingRepositoryImpl(gh<_i127.UserProfileRepository>()));
    ...
    gh.factory<_i206.SaveCredentialsUseCase>(
        () => _i206.SaveCredentialsUseCase(gh<_i144.AuthRepository>()));
    ...
    gh.factory<_i209.SaveUserProfileUseCase>(
        () => _i209.SaveUserProfileUseCase(gh<_i127.UserProfileRepository>()));
    gh.factory<_i210.SaveVitalSignsUseCase>(
        () => _i210.SaveVitalSignsUseCase(gh<_i132.VitalSignRepository>()));
    gh.factory<_i211.SecondOpinionCubit>(
        () => _i211.SecondOpinionCubit(gh<_i111.SecondOpinionRepository>()));
    gh.factory<_i212.SendMessageUseCase>(
        () => _i212.SendMessageUseCase(gh<_i135.VoiceChatRepository>()));
    gh.factory<_i213.SetPinUseCase>(() => _i213.SetPinUseCase(
          gh<_i144.AuthRepository>(),
          gh<_i162.EncryptionService>(),
        ));
    gh.lazySingleton<_i214.SmartSearchUseCase>(
        () => _i214.SmartSearchUseCase(gh<_i130.VectorStoreService>()));
    ...
    gh.factory<_i220.UserProfileCubit>(
        () => _i220.UserProfileCubit(gh<_i127.UserProfileRepository>()));
    gh.factory<_i221.ValidateSessionUseCase>(
        () => _i221.ValidateSessionUseCase(gh<_i144.AuthRepository>()));
    gh.factory<_i222.VitalSignBloc>(
        () => _i222.VitalSignBloc(gh<_i132.VitalSignRepository>()));
    ...
    gh.lazySingleton<_i228.AuthService>(
        () => _i228.AuthServiceImpl(gh<_i162.EncryptionService>()));
    ...
    gh.lazySingleton<_i235.DataSourceRepository>(
        () => _i236.DataSourceRepositoryImpl(
              ...
              gh<_i181.HealthConnectDataSource>(),
            ));
    gh.lazySingleton<_i237.DistributedCacheUsecase>(() =>
        _i237.DistributedCacheUsecase(gh<_i155.DistributedStorageService>()));
