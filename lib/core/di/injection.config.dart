...
import '../../features/appointments/domain/usecases/save_appointment_usecase.dart'
    as _i109;
import '../../features/auth/application/auth_cubit.dart' as _i231;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i171.GetChatHistoryUseCase>(
        () => _i171.GetChatHistoryUseCase(gh<_i131.VectorStoreService>()));
    gh.factory<_i172.GetChatHistoryUseCase>(
        () => _i172.GetChatHistoryUseCase(gh<_i136.VoiceChatRepository>()));
    ...
    gh.factory<_i231.AuthCubit>(() => _i231.AuthCubit(gh<_i149.AuthService>()));
