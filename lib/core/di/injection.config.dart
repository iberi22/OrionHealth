...
import '../../features/appointments/infrastructure/repositories/isar_appointment_repository.dart'
    as _i58;
import '../../features/auth/application/auth_cubit.dart' as _i82;
import '../../features/auth/application/bloc/auth_cubit.dart' as _i83;
import '../../features/auth/domain/auth_service.dart' as _i61;
import '../../features/auth/domain/repositories/auth_repository.dart' as _i59;
...
import '../../features/local_agent/infrastructure/gemma_llm_service.dart'
    as _i73;
import '../../features/local_agent/infrastructure/llm_service.dart' as _i72;
import '../../features/local_agent/infrastructure/rag_llm_service.dart' as _i85;
...
import '../../features/medications/infrastructure/repositories/isar_medication_repository.dart'
    as _i33;
import '../../features/onboarding/application/sync_cubit.dart' as _i80;
import '../../features/reports/application/bloc/report_bloc.dart' as _i87;
...
import '../../features/reports/infrastructure/services/mock_report_generation_service.dart'
    as _i34;
import '../../features/settings/application/llm_settings_cubit.dart' as _i74;
...
import '../../features/settings/infrastructure/repositories/llm_settings_repository_impl.dart'
    as _i20;
import '../../features/ssi/domain/repositories/ssi_repository.dart' as _i41;
import '../../features/ssi/domain/services/anoncreds_service.dart' as _i55;
import '../../features/ssi/domain/services/ssi_service.dart' as _i43;
...
import 'database_module.dart' as _i90;
import 'memory_module.dart' as _i89;
import 'network_module.dart' as _i88;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i37.PromptScrubber>(
        () => _i37.PromptScrubber(gh<_i14.Isar>()));
    gh.lazySingleton<_i38.ReportRepository>(
        () => _i39.IsarReportRepository(gh<_i14.Isar>()));
    gh.lazySingleton<_i40.SidetreeAnchorClient>(
        () => _i40.SidetreeAnchorClient.create());
    gh.lazySingleton<_i41.SsiRepository>(
        () => _i42.IsarSsiRepository(gh<_i14.Isar>()));
    gh.lazySingleton<_i43.SsiService>(() => _i44.SsiServiceImpl(
          gh<_i41.SsiRepository>(),
          gh<_i40.SidetreeAnchorClient>(),
        ));
    gh.factory<_i45.SymptomAnalysisStrategy>(
        () => _i45.SymptomAnalysisStrategy());
    gh.lazySingleton<_i22.SyncService>(() => networkModule.syncService);
    gh.lazySingleton<_i46.UserProfileRepository>(
        () => _i47.UserProfileRepositoryImpl(gh<_i14.Isar>()));
    gh.lazySingleton<_i48.VectorStoreService>(() => _i49.IsarVectorStoreService(
          gh<_i9.MemoryGraph>(),
          gh<_i23.MedicalKnowledgeRepository>(),
        ));
    gh.factory<_i50.VitalAnalysisStrategy>(() => _i50.VitalAnalysisStrategy());
    gh.lazySingleton<_i51.VitalSignRepository>(
        () => _i52.VitalSignRepositoryImpl(gh<_i14.Isar>()));
    gh.lazySingleton<_i53.AllergyRepository>(
        () => _i54.IsarAllergyRepository(gh<_i14.Isar>()));
    gh.lazySingleton<_i55.AnonCredsService>(
        () => _i56.AnonCredsServiceImpl(gh<_i41.SsiRepository>()));
    gh.lazySingleton<_i57.AppointmentRepository>(
        () => _i58.IsarAppointmentRepository(gh<_i14.Isar>()));
    gh.lazySingleton<_i59.AuthRepository>(
        () => _i60.AuthRepositoryImpl(gh<_i14.Isar>()));
    gh.lazySingleton<_i61.AuthService>(
        () => _i61.AuthServiceImpl(gh<_i10.EncryptionService>()));
    gh.lazySingleton<_i62.BleMedicalSharingService>(
        () => _i62.BleMedicalSharingService(
              gh<_i4.BleSharingService>(),
              gh<_i10.EncryptionService>(),
              gh<_i43.SsiService>(),
            ));
    gh.lazySingleton<_i63.ClinicalReasonerService>(() =>
        _i64.SymphonyClinicalReasonerService(
            gh<_i23.MedicalKnowledgeRepository>()));
    gh.lazySingleton<_i65.HealthContextService>(
        () => _i66.IsarHealthContextService(
              gh<_i51.VitalSignRepository>(),
              gh<_i32.MedicationRepository>(),
              gh<_i9.MemoryGraph>(),
            ));
    gh.factory<_i67.HealthImportCubit>(() => _i67.HealthImportCubit(
          gh<_i12.HealthDataImportService>(),
          gh<_i51.VitalSignRepository>(),
        ));
    gh.lazySingleton<_i68.HealthRecordRepository>(
        () => _i69.HealthRecordRepositoryImpl(gh<_i14.Isar>()));
    gh.factory<_i16.LlmAdapter>(
      () => _i70.MockLlmAdapter(gh<_i37.PromptScrubber>()),
      instanceName: 'mock',
    );
    gh.lazySingleton<_i16.LlmAdapter>(
    ...
    gh.lazySingleton<_i72.LlmService>(() => _i73.GemmaLlmService(
          gh<_i48.VectorStoreService>(),
          gh<_i46.UserProfileRepository>(),
          gh<_i16.LlmAdapter>(instanceName: 'gemma'),
        ));
    gh.factory<_i74.LlmSettingsCubit>(() => _i74.LlmSettingsCubit(
          gh<_i19.LlmSettingsRepository>(),
          gh<_i6.DeviceCapabilityService>(),
          gh<_i16.LlmAdapter>(instanceName: 'gemma'),
        ));
    gh.lazySingleton<_i75.MedicalResearchService>(
        () => _i75.MedicalResearchService(
              gh<_i30.MedicalWebSearchService>(),
              gh<_i26.MedicalScraperService>(),
            ));
    gh.lazySingleton<_i76.PatientContextIndexer>(
      () => _i76.PatientContextIndexer(
        gh<_i14.Isar>(),
        gh<_i48.VectorStoreService>(),
        gh<_i68.HealthRecordRepository>(),
        gh<_i32.MedicationRepository>(),
        gh<_i53.AllergyRepository>(),
        gh<_i51.VitalSignRepository>(),
        gh<_i57.AppointmentRepository>(),
      ),
      dispose: (i) => i.dispose(),
    );
    gh.lazySingleton<_i77.ReportGenerationService>(
        () => _i78.GemmaReportGenerationService(
              gh<_i16.LlmAdapter>(instanceName: 'gemma'),
              gh<_i48.VectorStoreService>(),
              gh<_i46.UserProfileRepository>(),
              gh<_i37.PromptScrubber>(),
            ));
    gh.lazySingleton<_i79.SmartSearchUseCase>(
        () => _i79.SmartSearchUseCase(gh<_i48.VectorStoreService>()));
    gh.factory<_i80.SyncCubit>(() => _i80.SyncCubit(
          gh<_i22.SyncService>(),
          gh<_i48.VectorStoreService>(),
        ));
    gh.factory<_i81.UserProfileCubit>(
        () => _i81.UserProfileCubit(gh<_i46.UserProfileRepository>()));
    gh.factory<_i82.AuthCubit>(() => _i82.AuthCubit(gh<_i61.AuthService>()));
    gh.factory<_i83.AuthCubit>(() => _i83.AuthCubit(
          gh<_i59.AuthRepository>(),
          gh<_i10.EncryptionService>(),
          gh<_i3.BiometricService>(),
        ));
    gh.factory<_i84.HealthRecordCubit>(() => _i84.HealthRecordCubit(
          gh<_i68.HealthRecordRepository>(),
    ...
    gh.lazySingleton<_i72.LlmService>(
      () => _i85.RagLlmService(
        gh<_i48.VectorStoreService>(),
        gh<_i75.MedicalResearchService>(),
        gh<_i46.UserProfileRepository>(),
        gh<_i16.LlmAdapter>(instanceName: 'gemma'),
      ),
      instanceName: 'rag',
    );
    gh.lazySingleton<_i86.MedicalIndexingService>(
        () => _i86.MedicalIndexingService(
              gh<_i23.MedicalKnowledgeRepository>(),
              gh<_i48.VectorStoreService>(),
              gh<_i76.PatientContextIndexer>(),
            ));
    gh.factory<_i87.ReportBloc>(() => _i87.ReportBloc(
          gh<_i38.ReportRepository>(),
          gh<_i77.ReportGenerationService>(),
        ));
    return this;
  }
}
...
class _$MemoryModule extends _i89.MemoryModule {}
