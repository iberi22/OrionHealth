...
import '../../features/auth/domain/auth_service.dart' as _i96;
import '../../features/auth/domain/repositories/auth_repository.dart' as _i94;
...
import '../../features/doctor_verification/domain/services/license_verifier.dart'
    as _i26;
import '../../features/email-citas/application/email_citas_cubit.dart' as _i106;
...
import '../../features/health_record/infrastructure/services/ocr_service.dart'
    as _i57;
import '../../features/health_sharing/application/sharing_cubit.dart' as _i67;
...
import '../../features/home/infrastructure/home_repository_impl.dart' as _i148;
...
import '../../features/local_agent/infrastructure/gemma_llm_service.dart'
    as _i119;
import '../../features/local_agent/infrastructure/llm_service.dart' as _i118;
...
import '../../features/onboarding/application/sync_cubit.dart' as _i130;
...
import '../../features/reports/infrastructure/services/mock_report_generation_service.dart'
    as _i50;
import '../../features/settings/application/llm_settings_cubit.dart' as _i120;
...
import '../../features/settings/infrastructure/repositories/llm_settings_repository_impl.dart'
    as _i32;
import '../../features/ssi/application/ssi_cubit.dart' as _i129;
import '../../features/ssi/domain/repositories/ssi_repository.dart' as _i70;
import '../../features/ssi/domain/services/anoncreds_service.dart' as _i89;
import '../../features/ssi/domain/services/ssi_service.dart' as _i72;
...
import '../../features/sync/data/sync_repository.dart' as _i76;
import '../../features/sync/domain/repositories/sync_repository.dart' as _i134;
import '../../features/sync/domain/services/sync_service.dart' as _i132;
import '../../features/sync/domain/sync_cubit.dart' as _i140;
import '../../features/sync/domain/sync_repository.dart' as _i75;
import '../../features/sync/domain/sync_service.dart' as _i131;
...
import '../../features/user_profile/infrastructure/repositories/user_profile_repository_impl.dart'
    as _i78;
import '../../features/vitals/application/vitals_cubit.dart' as _i86;
...
import 'database_module.dart' as _i152;
import 'fhir_module.dart' as _i149;
import 'memory_module.dart' as _i151;
import 'network_module.dart' as _i150;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i66.SensorHealthDataSource>(
        () => _i66.SensorHealthDataSourceImpl());
    gh.factory<_i67.SharingCubit>(() => _i67.SharingCubit(
          bleService: gh<_i6.BleSharingService>(),
          nfcService: gh<_i52.NfcSharingService>(),
          wifiService: gh<_i68.WifiDirectService>(),
        ));
    gh.lazySingleton<_i69.SidetreeAnchorClient>(
        () => _i69.SidetreeAnchorClient.create());
    gh.lazySingleton<_i70.SsiRepository>(
        () => _i71.IsarSsiRepository(gh<_i22.Isar>()));
    gh.lazySingleton<_i72.SsiService>(() => _i73.SsiServiceImpl(
          gh<_i70.SsiRepository>(),
          gh<_i69.SidetreeAnchorClient>(),
        ));
    gh.factory<_i74.SymptomAnalysisStrategy>(
        () => _i74.SymptomAnalysisStrategy());
    gh.lazySingleton<_i75.SyncRepository>(() => _i76.SyncRepositoryImpl(
          gh<_i18.FhirClient>(),
          gh<_i22.Isar>(),
    ...
    gh.lazySingleton<_i77.UserProfileRepository>(
        () => _i78.UserProfileRepositoryImpl(gh<_i22.Isar>()));
    gh.lazySingleton<_i79.UserProfileService>(
        () => _i79.UserProfileService(gh<_i77.UserProfileRepository>()));
    gh.lazySingleton<_i80.VectorStoreService>(() => _i81.IsarVectorStoreService(
          gh<_i16.MemoryGraph>(),
          gh<_i37.MedicalKnowledgeRepository>(),
        ));
    gh.factory<_i82.VitalAnalysisStrategy>(() => _i82.VitalAnalysisStrategy());
    gh.factory<_i83.VitalSignAnalyzer>(() => _i83.VitalSignAnalyzer());
    gh.lazySingleton<_i84.VitalSignRepository>(
        () => _i85.VitalSignRepositoryImpl(gh<_i22.Isar>()));
    gh.factory<_i86.VitalsCubit>(
        () => _i86.VitalsCubit(gh<_i84.VitalSignRepository>()));
    gh.lazySingleton<_i68.WifiDirectService>(() => _i68.WifiDirectService());
    gh.lazySingleton<_i87.AllergyRepository>(
        () => _i88.IsarAllergyRepository(gh<_i22.Isar>()));
    gh.lazySingleton<_i89.AnonCredsService>(
        () => _i90.AnonCredsServiceImpl(gh<_i70.SsiRepository>()));
    gh.lazySingleton<_i91.AppointmentRepository>(
        () => _i92.IsarAppointmentRepository(gh<_i22.Isar>()));
    gh.factory<_i93.AppointmentsCubit>(
        () => _i93.AppointmentsCubit(gh<_i91.AppointmentRepository>()));
    gh.lazySingleton<_i94.AuthRepository>(
        () => _i95.AuthRepositoryImpl(gh<_i22.Isar>()));
    gh.lazySingleton<_i96.AuthService>(
        () => _i96.AuthServiceImpl(gh<_i17.EncryptionService>()));
    gh.lazySingleton<_i97.BleMedicalSharingService>(
        () => _i97.BleMedicalSharingService(
              gh<_i6.BleSharingService>(),
              gh<_i17.EncryptionService>(),
              gh<_i72.SsiService>(),
            ));
    gh.factory<_i98.CalendarImportCubit>(() => _i98.CalendarImportCubit(
          gh<_i9.CalendarRepository>(),
          gh<_i91.AppointmentRepository>(),
          gh<_i77.UserProfileRepository>(),
        ));
    gh.lazySingleton<_i99.ClinicalReasonerService>(
        () => _i100.SymphonyClinicalReasonerService(
              gh<_i37.MedicalKnowledgeRepository>(),
              gh<_i59.PromptScrubber>(),
            ));
    gh.lazySingleton<_i101.DashboardRepository>(
        () => _i102.DashboardRepositoryImpl(
              gh<_i84.VitalSignRepository>(),
              gh<_i47.MedicationRepository>(),
              gh<_i62.ReportRepository>(),
            ));
    gh.lazySingleton<_i103.DoctorProfileRepository>(
        () => _i104.IsarDoctorProfileRepository(gh<_i22.Isar>()));
    gh.factoryAsync<_i105.DoctorVerificationCubit>(
        () async => _i105.DoctorVerificationCubit(
              gh<_i103.DoctorProfileRepository>(),
              gh<_i60.RatingRepository>(),
              await getAsync<_i26.LicenseVerifier>(),
            ));
    gh.factory<_i106.EmailCitasCubit>(() => _i106.EmailCitasCubit(
          gh<_i14.EmailRepository>(),
          gh<_i91.AppointmentRepository>(),
        ));
    gh.factory<_i107.EpsConnectionCubit>(() => _i107.EpsConnectionCubit(
          gh<_i54.OAuthRepository>(),
          gh<_i77.UserProfileRepository>(),
        ));
    gh.lazySingleton<_i66.FileHealthDataSource>(
        () => _i66.FileHealthDataSourceImpl(
              gh<_i19.FilePickerService>(),
              gh<_i57.OcrService>(),
            ));
    gh.lazySingleton<_i108.HealthContextService>(
        () => _i109.IsarHealthContextService(
              gh<_i84.VitalSignRepository>(),
              gh<_i47.MedicationRepository>(),
              gh<_i77.UserProfileRepository>(),
              gh<_i16.MemoryGraph>(),
            ));
    gh.lazySingleton<_i110.HealthDataRepository>(
        () => _i110.HealthDataRepositoryImpl(
              gh<_i66.SensorHealthDataSource>(),
              gh<_i66.FileHealthDataSource>(),
            ));
    gh.factory<_i111.HealthImportCubit>(() => _i111.HealthImportCubit(
          gh<_i20.HealthDataImportService>(),
          gh<_i84.VitalSignRepository>(),
        ));
    gh.lazySingleton<_i112.HealthRecordRepository>(
        () => _i113.HealthRecordRepositoryImpl(gh<_i22.Isar>()));
    gh.factory<_i27.LlmAdapter>(
      () => _i114.MockLlmAdapter(gh<_i59.PromptScrubber>()),
      instanceName: 'mock',
    );
    gh.lazySingleton<_i27.LlmAdapter>(
      () => _i115.GeminiLlmAdapter(
        scrubber: gh<_i59.PromptScrubber>(),
        userProfileRepository: gh<_i77.UserProfileRepository>(),
        modelWrapper: gh<_i116.GeminiModelWrapper>(),
      ),
      instanceName: 'gemini',
    );
    gh.lazySingleton<_i117.LlmAdapterFactory>(
        () => _i117.LlmAdapterFactory(gh<_i31.LlmSettingsRepository>()));
    gh.lazySingleton<_i118.LlmService>(() => _i119.GemmaLlmService(
          gh<_i80.VectorStoreService>(),
          gh<_i77.UserProfileRepository>(),
          gh<_i27.LlmAdapter>(instanceName: 'gemma'),
        ));
    gh.factory<_i120.LlmSettingsCubit>(() => _i120.LlmSettingsCubit(
          gh<_i31.LlmSettingsRepository>(),
          gh<_i12.DeviceCapabilityService>(),
          gh<_i27.LlmAdapter>(instanceName: 'gemma'),
        ));
    gh.factory<_i121.MedicalAssistantCubit>(() => _i121.MedicalAssistantCubit(
          llmAdapter: gh<_i40.MedicalLlmAdapter>(),
          analysisService: gh<_i34.MedicalAnalysisService>(),
          healthContextService: gh<_i108.HealthContextService>(),
        ));
    gh.lazySingleton<_i122.MedicalResearchService>(
        () => _i122.MedicalResearchService(
              gh<_i45.MedicalWebSearchService>(),
              gh<_i41.MedicalScraperService>(),
            ));
    gh.lazySingleton<_i123.OnboardingRepository>(
        () => _i124.OnboardingRepositoryImpl(gh<_i77.UserProfileRepository>()));
    gh.lazySingleton<_i125.PatientContextIndexer>(
      () => _i125.PatientContextIndexer(
        gh<_i22.Isar>(),
        gh<_i80.VectorStoreService>(),
        gh<_i112.HealthRecordRepository>(),
        gh<_i47.MedicationRepository>(),
        gh<_i87.AllergyRepository>(),
        gh<_i84.VitalSignRepository>(),
        gh<_i91.AppointmentRepository>(),
      ),
      dispose: (i) => i.dispose(),
    );
    gh.lazySingleton<_i126.ReportGenerationService>(
        () => _i127.GemmaReportGenerationService(
              gh<_i27.LlmAdapter>(instanceName: 'gemma'),
              gh<_i80.VectorStoreService>(),
              gh<_i77.UserProfileRepository>(),
              gh<_i59.PromptScrubber>(),
            ));
    gh.lazySingleton<_i128.SmartSearchUseCase>(
        () => _i128.SmartSearchUseCase(gh<_i80.VectorStoreService>()));
    gh.factory<_i129.SsiCubit>(() => _i129.SsiCubit(gh<_i70.SsiRepository>()));
    gh.factory<_i130.SyncCubit>(() => _i130.SyncCubit(
          gh<_i35.SyncService>(),
          gh<_i80.VectorStoreService>(),
        ));
    gh.lazySingleton<_i131.SyncService>(() => _i131.SyncService(
          gh<_i75.SyncRepository>(),
          gh<_i77.UserProfileRepository>(),
        ));
    gh.lazySingleton<_i132.SyncService>(() => _i133.SyncServiceImpl(
          gh<_i134.SyncRepository>(),
          gh<_i35.SyncService>(),
        ));
    gh.factory<_i135.UserProfileCubit>(
        () => _i135.UserProfileCubit(gh<_i77.UserProfileRepository>()));
    gh.factory<_i136.AllergiesCubit>(
        () => _i136.AllergiesCubit(gh<_i87.AllergyRepository>()));
    gh.factory<_i137.AuthCubit>(() => _i137.AuthCubit(gh<_i96.AuthService>()));
    ...
    gh.factory<_i139.DashboardCubit>(
        () => _i139.DashboardCubit(gh<_i101.DashboardRepository>()));
    gh.factory<_i140.FhirSyncCubit>(
        () => _i140.FhirSyncCubit(gh<_i131.SyncService>()));
    ...
    gh.lazySingleton<_i118.LlmService>(
      () => _i143.RagLlmService(
        gh<_i80.VectorStoreService>(),
        gh<_i122.MedicalResearchService>(),
        gh<_i77.UserProfileRepository>(),
        gh<_i27.LlmAdapter>(instanceName: 'gemma'),
      ),
      instanceName: 'rag',
    ...
    gh.lazySingleton<_i144.MedicalIndexingService>(
        () => _i144.MedicalIndexingService(
              gh<_i37.MedicalKnowledgeRepository>(),
              gh<_i80.VectorStoreService>(),
              gh<_i125.PatientContextIndexer>(),
            ));
    ...
    gh.factory<_i146.ReportBloc>(() => _i146.ReportBloc(
          gh<_i62.ReportRepository>(),
          gh<_i126.ReportGenerationService>(),
        ));
...
class _$FhirModule extends _i149.FhirModule {}

class _$NetworkModule extends _i150.NetworkModule {}

class _$MemoryModule extends _i151.MemoryModule {}

class _$DatabaseModule extends _i152.DatabaseModule {}
