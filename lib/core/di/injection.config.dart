...
import '../../features/appointments/infrastructure/repositories/appointment_repository_impl.dart'
    as _i51;
import '../../features/auth/application/auth_cubit.dart' as _i75;
import '../../features/auth/domain/auth_service.dart' as _i52;
...
import '../../features/local_agent/infrastructure/gemma_llm_service.dart'
    as _i64;
import '../../features/local_agent/infrastructure/llm_service.dart' as _i63;
import '../../features/local_agent/infrastructure/rag_llm_service.dart' as _i77;
...
import '../../features/medications/infrastructure/repositories/isar_medication_repository.dart'
    as _i30;
import '../../features/onboarding/application/onboarding_cubit.dart' as _i68;
import '../../features/onboarding/application/sync_cubit.dart' as _i73;
import '../../features/reports/application/bloc/report_bloc.dart' as _i78;
...
import '../../features/reports/infrastructure/services/mock_report_generation_service.dart'
    as _i31;
import '../../features/settings/application/llm_settings_cubit.dart' as _i65;
...
import 'database_module.dart' as _i81;
import 'memory_module.dart' as _i80;
import 'network_module.dart' as _i79;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i50.AppointmentRepository>(
        () => _i51.AppointmentRepositoryImpl(gh<_i13.Isar>()));
    gh.lazySingleton<_i52.AuthService>(
        () => _i52.AuthServiceImpl(gh<_i9.EncryptionService>()));
    gh.lazySingleton<_i53.BleMedicalSharingService>(
        () => _i53.BleMedicalSharingService(
              gh<_i3.BleSharingService>(),
              gh<_i9.EncryptionService>(),
              gh<_i40.SsiService>(),
            ));
    gh.lazySingleton<_i54.ClinicalReasonerService>(() =>
        _i55.SymphonyClinicalReasonerService(
            gh<_i20.MedicalKnowledgeRepository>()));
    gh.lazySingleton<_i56.HealthContextService>(
        () => _i57.IsarHealthContextService(
              gh<_i46.VitalSignRepository>(),
              gh<_i29.MedicationRepository>(),
              gh<_i8.MemoryGraph>(),
            ));
    gh.factory<_i58.HealthImportCubit>(() => _i58.HealthImportCubit(
          gh<_i11.HealthDataImportService>(),
          gh<_i46.VitalSignRepository>(),
        ));
    gh.lazySingleton<_i59.HealthRecordRepository>(
        () => _i60.HealthRecordRepositoryImpl(gh<_i13.Isar>()));
    gh.factory<_i14.LlmAdapter>(
      () => _i61.MockLlmAdapter(gh<_i33.PromptScrubber>()),
      instanceName: 'mock',
    );
    gh.lazySingleton<_i14.LlmAdapter>(
      () => _i62.GeminiLlmAdapter(
        scrubber: gh<_i33.PromptScrubber>(),
        userProfileRepository: gh<_i42.UserProfileRepository>(),
      ),
      instanceName: 'gemini',
    );
    gh.lazySingleton<_i63.LlmService>(() => _i64.GemmaLlmService(
          gh<_i44.VectorStoreService>(),
          gh<_i42.UserProfileRepository>(),
          gh<_i14.LlmAdapter>(instanceName: 'gemma'),
        ));
    gh.factory<_i65.LlmSettingsCubit>(() => _i65.LlmSettingsCubit(
          gh<_i17.LlmSettingsRepository>(),
          gh<_i6.DeviceCapabilityService>(),
        ));
    gh.lazySingleton<_i66.MedicalIndexingService>(
        () => _i66.MedicalIndexingService(
              gh<_i20.MedicalKnowledgeRepository>(),
              gh<_i44.VectorStoreService>(),
            ));
    gh.lazySingleton<_i67.MedicalResearchService>(
        () => _i67.MedicalResearchService(
              gh<_i27.MedicalWebSearchService>(),
              gh<_i23.MedicalScraperService>(),
            ));
    gh.factory<_i68.OnboardingCubit>(
        () => _i68.OnboardingCubit(gh<_i42.UserProfileRepository>()));
    gh.lazySingleton<_i69.ReportGenerationService>(
        () => _i70.GemmaReportGenerationService(
              gh<_i14.LlmAdapter>(instanceName: 'gemma'),
              gh<_i44.VectorStoreService>(),
              gh<_i42.UserProfileRepository>(),
              gh<_i33.PromptScrubber>(),
            ));
    gh.lazySingleton<_i71.RiskCalculator>(
        () => _i71.RiskCalculator(gh<_i42.UserProfileRepository>()));
    gh.lazySingleton<_i72.SmartSearchUseCase>(
        () => _i72.SmartSearchUseCase(gh<_i44.VectorStoreService>()));
    gh.factory<_i73.SyncCubit>(() => _i73.SyncCubit(
          gh<_i19.SyncService>(),
          gh<_i44.VectorStoreService>(),
        ));
    gh.factory<_i74.UserProfileCubit>(
        () => _i74.UserProfileCubit(gh<_i42.UserProfileRepository>()));
    gh.factory<_i75.AuthCubit>(() => _i75.AuthCubit(gh<_i52.AuthService>()));
    gh.factory<_i76.HealthRecordCubit>(() => _i76.HealthRecordCubit(
          gh<_i59.HealthRecordRepository>(),
          gh<_i10.FilePickerService>(),
          gh<_i12.ImagePickerService>(),
          gh<_i32.OcrService>(),
          gh<_i44.VectorStoreService>(),
        ));
    gh.lazySingleton<_i63.LlmService>(
      () => _i77.RagLlmService(
        gh<_i44.VectorStoreService>(),
        gh<_i67.MedicalResearchService>(),
        gh<_i42.UserProfileRepository>(),
        gh<_i14.LlmAdapter>(instanceName: 'gemma'),
      ),
      instanceName: 'rag',
    );
    gh.factory<_i78.ReportBloc>(() => _i78.ReportBloc(
          gh<_i34.ReportRepository>(),
          gh<_i69.ReportGenerationService>(),
        ));
    return this;
  }
}
...
class _$MemoryModule extends _i80.MemoryModule {}
