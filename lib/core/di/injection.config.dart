...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i22.VitalSignRepository>(
        () => _i23.VitalSignRepositoryImpl(gh<_i8.Isar>()));
    gh.lazySingleton<_i24.AllergyRepository>(
        () => _i25.AllergyRepositoryImpl(gh<_i8.Isar>()));
    gh.lazySingleton<_i26.AppointmentRepository>(
        () => _i27.AppointmentRepositoryImpl(gh<_i8.Isar>()));
    gh.lazySingleton<_i28.AuthRepository>(() => _i29.AuthRepositoryImpl(
          gh<_i8.Isar>(),
          gh<_i5.EncryptionService>(),
          gh<_i3.BiometricService>(),
        ));
    gh.lazySingleton<_i30.BleMedicalSharingService>(
        () => _i30.BleMedicalSharingService(gh<_i5.EncryptionService>()));
    ...
    gh.lazySingleton<_i35.LlmService>(
        () => _i36.RagLlmService(gh<_i20.VectorStoreService>()));
    gh.lazySingleton<_i37.SmartSearchUseCase>(
        () => _i37.SmartSearchUseCase(gh<_i20.VectorStoreService>()));
    gh.factory<_i38.UserProfileCubit>(
        () => _i38.UserProfileCubit(gh<_i18.UserProfileRepository>()));
    gh.lazySingleton<_i39.AuthCubit>(
        () => _i39.AuthCubit(gh<_i28.AuthRepository>()));
