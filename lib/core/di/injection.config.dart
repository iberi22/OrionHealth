...
import '../../features/auth/domain/usecases/get_credentials_usecase.dart'
    as _i174;
import '../../features/auth/domain/usecases/login_usecase.dart' as _i199;
import '../../features/auth/domain/usecases/logout_usecase.dart' as _i200;
...
import '../../features/local_agent/infrastructure/gemma_llm_service.dart'
    as _i197;
import '../../features/local_agent/infrastructure/llm_service.dart' as _i196;
...
import '../../features/medications/application/bloc/medication_bloc.dart'
    as _i258;
import '../../features/medications/application/medications_cubit.dart' as _i204;
...
import '../../features/medications/infrastructure/services/rxnorm_api_service.dart'
    as _i101;
import '../../features/meditation/application/meditation_cubit.dart' as _i205;
...
import '../../features/meditation/infrastructure/repositories/meditation_repository_impl.dart'
    as _i82;
import '../../features/network/application/network_cubit.dart' as _i206;
...
import '../../features/reports/infrastructure/services/mock_report_generation_service.dart'
    as _i83;
import '../../features/settings/application/llm_settings_cubit.dart' as _i198;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i145.AssessmentLocalDataSource>(
        () => _i145.AssessmentLocalDataSource(gh<_i60.Isar>()));
    ...
    gh.lazySingleton<_i165.EncryptionService>(
        () => _i165.EncryptionService(gh<_i113.SecureStorageService>()));
    ...
    gh.factory<_i170.GetAllVitalSignsUseCase>(
        () => _i170.GetAllVitalSignsUseCase(gh<_i134.VitalSignRepository>()));
    ...
    gh.factory<_i172.GetChatHistoryUseCase>(
        () => _i172.GetChatHistoryUseCase(gh<_i137.VoiceChatRepository>()));
    ...
    gh.factory<_i181.GetUserProfileUseCase>(
        () => _i181.GetUserProfileUseCase(gh<_i129.UserProfileRepository>()));
    ...
    gh.lazySingleton<_i185.HealthConnectDataSource>(
        () => _i185.HealthConnectDataSourceImpl(gh<_i49.HealthWrapper>()));
    ...
    gh.lazySingleton<_i190.IAssessmentRepository>(() =>
        _i191.AssessmentRepositoryImpl(gh<_i145.AssessmentLocalDataSource>()));
    gh.factory<_i192.ImportCalendarUseCase>(() => _i192.ImportCalendarUseCase(
    ...
    gh.factory<_i63.LlmAdapter>(
      () => _i194.MockLlmAdapter(gh<_i102.PromptScrubber>()),
      instanceName: 'mock',
    );
    gh.lazySingleton<_i195.LlmAdapterFactory>(
        () => _i195.LlmAdapterFactory(gh<_i118.SettingsRepository>()));
    gh.lazySingleton<_i196.LlmService>(() => _i197.GemmaLlmService(
          gh<_i132.VectorStoreService>(),
          gh<_i129.UserProfileRepository>(),
          gh<_i63.LlmAdapter>(instanceName: 'gemma'),
        ));
    gh.factory<_i198.LlmSettingsCubit>(() => _i198.LlmSettingsCubit(
          gh<_i118.SettingsRepository>(),
          gh<_i29.DeviceCapabilityService>(),
          gh<_i63.LlmAdapter>(instanceName: 'gemma'),
        ));
    gh.factory<_i199.LoginUseCase>(() => _i199.LoginUseCase(
          gh<_i147.AuthRepository>(),
          gh<_i165.EncryptionService>(),
          gh<_i16.BiometricService>(),
        ));
    gh.factory<_i200.LogoutUseCase>(
        () => _i200.LogoutUseCase(gh<_i147.AuthRepository>()));
    ...
    gh.lazySingleton<_i202.MedicationRepository>(
        () => _i203.IsarMedicationRepository(
              gh<_i60.Isar>(),
              gh<_i100.PharmacyApiService>(),
            ));
    gh.factory<_i204.MedicationsCubit>(
        () => _i204.MedicationsCubit(gh<_i202.MedicationRepository>()));
    gh.factory<_i205.MeditationCubit>(() => _i205.MeditationCubit(
    ...
    gh.factory<_i206.NetworkCubit>(() => _i206.NetworkCubit(
          gh<_i87.NetworkPeerRepository>(),
          gh<_i86.NetworkP2PApi>(),
        ));
    gh.factory<_i207.NetworkHealthCubit>(() => _i207.NetworkHealthCubit(
          gh<_i176.GetNetworkHealth>(),
          gh<_i154.ConnectNode>(),
          gh<_i89.NetworkRepository>(),
        ));
    gh.lazySingleton<_i208.OnboardingRepository>(() =>
        _i209.OnboardingRepositoryImpl(gh<_i129.UserProfileRepository>()));
    gh.lazySingleton<_i210.ReportGenerationService>(
        () => _i211.GemmaReportGenerationService(
              gh<_i63.LlmAdapter>(instanceName: 'gemma'),
              gh<_i132.VectorStoreService>(),
              gh<_i129.UserProfileRepository>(),
    ...
    gh.factory<_i213.SaveMedicationUseCase>(
        () => _i213.SaveMedicationUseCase(gh<_i202.MedicationRepository>()));
    ...
    gh.factory<_i215.SaveUserProfileUseCase>(
        () => _i215.SaveUserProfileUseCase(gh<_i129.UserProfileRepository>()));
    gh.factory<_i216.SaveVitalSignsUseCase>(
        () => _i216.SaveVitalSignsUseCase(gh<_i134.VitalSignRepository>()));
    ...
    gh.factory<_i218.SendMessageUseCase>(
        () => _i218.SendMessageUseCase(gh<_i137.VoiceChatRepository>()));
    gh.factory<_i219.SetPinUseCase>(() => _i219.SetPinUseCase(
          gh<_i147.AuthRepository>(),
          gh<_i165.EncryptionService>(),
        ));
    gh.lazySingleton<_i220.SmartSearchUseCase>(
        () => _i220.SmartSearchUseCase(gh<_i132.VectorStoreService>()));
    ...
    gh.factory<_i224.UserProfileCubit>(
        () => _i224.UserProfileCubit(gh<_i129.UserProfileRepository>()));
    ...
    gh.factory<_i226.VitalSignBloc>(
        () => _i226.VitalSignBloc(gh<_i134.VitalSignRepository>()));
    ...
    gh.factory<_i228.VouchCubit>(
        () => _i228.VouchCubit(gh<_i139.VouchRepository>()));
    ...
    gh.factory<_i231.AuthCubit>(() => _i231.AuthCubit(
          gh<_i147.AuthRepository>(),
          gh<_i16.BiometricService>(),
          gh<_i199.LoginUseCase>(),
          gh<_i200.LogoutUseCase>(),
    ...
    gh.lazySingleton<_i232.AuthService>(
        () => _i232.AuthServiceImpl(gh<_i165.EncryptionService>()));
    ...
    gh.lazySingleton<_i241.DistributedCacheUsecase>(() =>
        _i241.DistributedCacheUsecase(gh<_i158.DistributedStorageService>()));
    ...
    gh.factory<_i244.GetAllMedicationsUseCase>(
        () => _i244.GetAllMedicationsUseCase(gh<_i202.MedicationRepository>()));
    ...
    gh.factory<_i246.GetAllergiesUseCase>(
        () => _i246.GetAllergiesUseCase(gh<_i229.AllergyRepository>()));
    ...
    gh.factory<_i248.GetOnboardingProfileUseCase>(() =>
        _i248.GetOnboardingProfileUseCase(gh<_i208.OnboardingRepository>()));
    ...
    gh.lazySingleton<_i196.LlmService>(
      () => _i255.RagLlmService(
        gh<_i132.VectorStoreService>(),
    ...
    gh.factory<_i258.MedicationBloc>(
        () => _i258.MedicationBloc(gh<_i202.MedicationRepository>()));
    gh.factory<_i259.OnboardingCubit>(
        () => _i259.OnboardingCubit(gh<_i208.OnboardingRepository>()));
    ...
    gh.factory<_i261.ReportBloc>(() => _i261.ReportBloc(
          gh<_i106.ReportRepository>(),
          gh<_i210.ReportGenerationService>(),
        ));
    gh.factory<_i262.SaveAllergyUseCase>(
        () => _i262.SaveAllergyUseCase(gh<_i229.AllergyRepository>()));
    ...
    gh.factory<_i265.AllergiesCubit>(
        () => _i265.AllergiesCubit(gh<_i229.AllergyRepository>()));
    gh.factory<_i266.AllergyBloc>(
        () => _i266.AllergyBloc(gh<_i229.AllergyRepository>()));
    gh.factory<_i267.AuthCubit>(() => _i267.AuthCubit(gh<_i232.AuthService>()));
