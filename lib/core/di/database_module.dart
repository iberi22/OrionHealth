...
// DoctorProfile, DoctorRating schemas removed in doctor_verification cleanup
  ...
  Future<Isar> get isar async {
    ...
    return Isar.open(
      [
        ...
        AppointmentSchema,
        AllergySchema,
        // DoctorProfileSchema, // removed in doctor_verification cleanup
        // DoctorRatingSchema, // removed in doctor_verification cleanup
        HealthRecordSchema,
        LabResultSchema,
        VitalSignSchema,
