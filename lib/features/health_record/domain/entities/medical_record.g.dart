...
const MedicalRecordSchema = CollectionSchema(
  ...
  indexes: {},
  links: {},
  embeddedSchemas: {r'MedicalAttachment': MedicalAttachmentSchema},
...
int _medicalRecordEstimateSize(
  ...
  {
    final offsets = allOffsets[MedicalAttachment]!;
    for (var i = 0; i < object.attachments.length; i++) {
      final value = object.attachments[i];
      bytesCount +=
          MedicalAttachmentSchema.estimateSize(value, offsets, allOffsets);
    }
  }
  {
...
void _medicalRecordSerialize(
  ...
  writer.writeObjectList<MedicalAttachment>(
    offsets[0],
    allOffsets,
    MedicalAttachmentSchema.serialize,
    object.attachments,
  );
...
MedicalRecord _medicalRecordDeserialize(
  ...
  final object = MedicalRecord(
    attachments: reader.readObjectList<MedicalAttachment>(
          offsets[0],
          MedicalAttachmentSchema.deserialize,
          allOffsets,
          MedicalAttachment(),
        ) ??
        const [],
...
P _medicalRecordDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readObjectList<MedicalAttachment>(
            offset,
            MedicalAttachmentSchema.deserialize,
            allOffsets,
            MedicalAttachment(),
...
const _MedicalRecordtypeEnumValueMap = {
  r'labResult': r'labResult',
  r'prescription': r'prescription',
  r'clinicalNote': r'clinicalNote',
  r'other': r'other',
};
const _MedicalRecordtypeValueEnumMap = {
  r'labResult': RecordType.labResult,
  r'prescription': RecordType.prescription,
  r'clinicalNote': RecordType.clinicalNote,
...
extension MedicalRecordQueryFilter
  ...
  QueryBuilder<MedicalRecord, MedicalRecord, QAfterFilterCondition> dateEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MedicalRecord, MedicalRecord, QAfterFilterCondition> dateBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension MedicalRecordQueryObject
    on QueryBuilder<MedicalRecord, MedicalRecord, QFilterCondition> {
  QueryBuilder<MedicalRecord, MedicalRecord, QAfterFilterCondition>
      attachmentsElement(FilterQuery<MedicalAttachment> q) {
    return QueryBuilder.apply(this, (query) {
...
extension MedicalRecordQuerySortBy
  ...
  QueryBuilder<MedicalRecord, MedicalRecord, QAfterSortBy> sortByDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.asc);
    });
  }

  QueryBuilder<MedicalRecord, MedicalRecord, QAfterSortBy> sortByDateDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MedicalRecord, MedicalRecord, QAfterSortBy> sortBySummaryDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MedicalRecordQuerySortThenBy
  ...
  QueryBuilder<MedicalRecord, MedicalRecord, QAfterSortBy> thenByDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.asc);
    });
  }

  QueryBuilder<MedicalRecord, MedicalRecord, QAfterSortBy> thenByDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.desc);
    });
  }
  ...
  QueryBuilder<MedicalRecord, MedicalRecord, QAfterSortBy> thenBySummary() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'summary', Sort.asc);
    });
  }

  QueryBuilder<MedicalRecord, MedicalRecord, QAfterSortBy> thenBySummaryDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'summary', Sort.desc);
    });
  }
...
extension MedicalRecordQueryWhereDistinct
  ...
  QueryBuilder<MedicalRecord, MedicalRecord, QDistinct> distinctByDate() {
    return QueryBuilder.apply(this, (query) {
...
extension MedicalRecordQueryProperty
  ...
  QueryBuilder<MedicalRecord, List<MedicalAttachment>, QQueryOperations>
      attachmentsProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MedicalRecord, String?, QQueryOperations> summaryProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'summary');
    });
  }

  QueryBuilder<MedicalRecord, RecordType, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
