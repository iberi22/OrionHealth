...
class OnboardingCubit extends Cubit<OnboardingState> {
  ...
  Future<void> startOnboarding() async {
    ...
    final profile = OnboardingUserProfile(
      createdAt: now,
      updatedAt: now,
      onboardingStep: 0,
  ...
  Future<void> resumeOnboarding(OnboardingUserProfile savedProfile) async {
  ...
  Future<void> updateBasicInfo({
    ...
    emit(currentState.copyWith(
      currentStep: OnboardingStep.basicInfo.stepIndex,
  ...
  Future<void> updateConditions(List<String> conditions) async {
    ...
    emit(currentState.copyWith(
      currentStep: OnboardingStep.conditions.stepIndex,
      profile: updatedProfile,
    ));
  }
  ...
  Future<void> updateFamilyHistory(List<String> familyHistory) async {
    ...
    emit(currentState.copyWith(
      currentStep: OnboardingStep.familyHistory.stepIndex,
      profile: updatedProfile,
    ));
  }
  ...
  Future<void> updateMedications(List<String> medications) async {
    ...
    emit(currentState.copyWith(
      currentStep: OnboardingStep.medications.stepIndex,
      profile: updatedProfile,
    ));
  }
  ...
  Future<void> acceptPrivacyConsent({
    ...
    emit(currentState.copyWith(
      currentStep: OnboardingStep.privacy.stepIndex,
      profile: updatedProfile,
    ));
  }
  ...
  Future<void> completeOnboarding() async {
    ...
    final completedProfile = currentState.profile.copyWith(
      onboardingStep: OnboardingStep.complete.stepIndex,
