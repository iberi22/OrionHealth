...
class OnboardingCubit extends Cubit<OnboardingState> {
  ...
  Future<void> startOnboarding() async {
    ...
    final savedProfile = await _onboardingRepository.getOnboardingProfile();
    ...
    await _onboardingRepository.saveOnboardingProfile(profile);
  ...
  Future<void> updateBasicInfo({
    ...
    await _onboardingRepository.saveOnboardingProfile(updatedProfile);
  ...
  Future<void> completeOnboarding() async {
    ...
    await _onboardingRepository.completeOnboarding(completedProfile);
  ...
  Future<void> skipOnboarding() async {
    ...
    await _onboardingRepository.completeOnboarding(skippedProfile);
