...
class _AppointmentsPageState extends State<AppointmentsPage> {
  ...
  Widget _buildCalendar() {
    ...
    // What: Pre-compute normalized appointment dates into a Set.
    // Why: Avoids O(N) lookup inside the GridView itemBuilder, preventing UI rendering bottlenecks.
    // Impact: Reduces complexity from O(N * D) to O(D) where N=appointments and D=days in month.
