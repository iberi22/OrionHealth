...
class WifiDirectService {
  ...
  Future<List<WifiDirectDevice>> discoverDevices({
    ...
    _stateController.add(const WifiSharingState.discovering());
  ...
  Future<void> _handleRequest(HttpRequest request) async {
    ...
    _stateController.add(const WifiSharingState.receiving());
    ...
    try {
      ...
      if (package.isExpired) {
        ...
        request.response.close();
        _stateController.add(const WifiSharingState.error('Package has expired'));
        return;
      }
...
class WifiSharingState {
  ...
  factory WifiSharingState.connecting(String address) => WifiSharingState._(
        status: 'connecting',
        address: address,
        message: 'Connecting to $_address...',
      );
