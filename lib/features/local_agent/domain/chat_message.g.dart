...
int _chatMessageEstimateSize(
  ...
  bytesCount += 3 + object.citations.length * 3;
  {
    for (var i = 0; i < object.citations.length; i++) {
      final value = object.citations[i];
...
void _chatMessageSerialize(
  ...
  writer.writeStringList(offsets[0], object.citations);
...
ChatMessage _chatMessageDeserialize(
  ...
  final object = ChatMessage(
    citations: reader.readStringList(offsets[0]) ?? const [],
    content: reader.readString(offsets[1]),
    id: id,
    role: _ChatMessageroleValueEnumMap[reader.readStringOrNull(offsets[2])] ??
        ChatRole.user,
...
extension ChatMessageQueryFilter
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      citationsElementEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'citations',
        value: value,
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      citationsElementContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      citationsElementMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterFilterCondition>
      citationsLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageQueryWhereDistinct
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByCitations() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'citations');
    });
  }
...
extension ChatMessageQueryProperty
  ...
  QueryBuilder<ChatMessage, List<String>, QQueryOperations>
      citationsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'citations');
    });
  }
