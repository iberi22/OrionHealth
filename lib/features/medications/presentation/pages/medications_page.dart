...
import '../widgets/medication_list_tile.dart';
import '../widgets/medication_empty_view.dart';
import '../widgets/medication_error_view.dart';
        ...
        body: BlocBuilder<MedicationsCubit, MedicationsState>(
          builder: (context, state) {
            if (state is MedicationsLoading || state is MedicationsInitial) {
              ...
              return MedicationErrorView(message: state.message);
            } else if (state is MedicationsLoaded) {
              if (state.medications.isEmpty) {
                return MedicationEmptyView(
                  onAdd: () => _showMedicationForm(context),
                );
              }
