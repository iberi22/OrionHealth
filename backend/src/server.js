...
app.get('/api/fhir/patient/:id', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ error: 'An error occurred fetching patient data' });
  }
});
...
app.get('/api/fhir/rda', async (req, res) => {
  ...
  try {
    ...
    console.error('Error fetching RDA:', error);
    res.status(500).json({ error: 'An error occurred fetching RDA data' });
  }
});
...
app.post('/api/gmail/appointments', async (req, res) => {
  ...
  try {
    ...
    console.error('Error fetching Gmail appointments:', error);
    res.status(500).send('An error occurred fetching Gmail appointments');
  }
});
...
app.post('/api/outlook/appointments', async (req, res) => {
  ...
  try {
    ...
    console.error('Error fetching Outlook appointments:', error);
    res.status(500).send('An error occurred fetching Outlook appointments');
  }
});
