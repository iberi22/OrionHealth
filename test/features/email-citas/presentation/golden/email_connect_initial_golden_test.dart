...
void main() {
  ...
  group('Email Connect Initial Golden Test', () {
    testWidgets('Email Connect Page - Initial State (Disconnected)', (tester) async {
      ...
      await expectLater(
        ...
        matchesGoldenFile("goldens/email_connect_initial.png"),
      );
