...
void main() {
  ...
  testWidgets('Onboarding Step 0 - Welcome Golden Test', (WidgetTester tester) async {
    ...
    when(() => mockOnboardingCubit.state).thenReturn(
      OnboardingInProgress(
        currentStep: 0,
        totalSteps: 7,
        profile: sampleProfile.copyWith(onboardingStep: 0),
      ),
    );
    ...
    await expectLater(
      ...
      matchesGoldenFile('goldens/onboarding_step_0.png'),
    );
