...
void main() {
  ...
  Widget createWidgetUnderTest() {
    return MaterialApp(
      home: BlocProvider<NetworkCubit>.value(
        value: mockNetworkCubit,
        child: const NetworkOverviewPage(),
      ),
    );
  }

  testWidgets('NetworkOverviewPage loading state golden test', (tester) async {
    ...
    // To run golden tests: flutter test --update-goldens
    await expectLater(
  ...
  testWidgets('NetworkOverviewPage loaded state golden test', (tester) async {
    final peers = [
      NetworkPeer(
        peerId: '1',
        name: 'Peer 1',
