...
abstract class IsarCollectionAuthCredentials extends IsarCollection<AuthCredentials> {}
class MockIsarCollection extends Mock implements IsarCollectionAuthCredentials {}
...
void main() {
  ...
  group('AuthRepositoryImpl', () {
    test('saveCredentials puts credentials in collection', () async {
      final credentials = AuthCredentials()..hashedPin = '1234';
